...
},
{
  ...
  },
  {
    ...
    changespecial: [{
      ...
      types: ['action', 'fullpower'],
      cost: '0',
      text: '组装1个零件，执行至多1次基本动作。\n【使用后】每当你将要重铸牌库时，你可以拆除1个已组装的零件。若如此做，则组装X个零件，X等于你的盖牌张数的一半（向上取整）。',
...
},
{
  ...
  list: [{
    ...
    normal: [{
      ...
      range: '4-7',
      damage: '2/1',
      text: '【常时】若你的瞄准点位于攻击距离内，则此《攻击》的对装伤害变为“-”。\n【攻击后】若当前距离与瞄准点的值相等，则虚（1）→自装',
      ...
      range: '5-15',
      damage: '5/1',
      text: '追踪\n【攻击后】对手弃1张《攻击》牌。若不能如此做，对手须展示其手牌，并盖伏其牌库顶的3张牌。',
      ...
      baseType: 'normal',
      types: ['action'],
      text: '获得1点集中力。\n本回合内，对于你进行的下一次其他女神的对装伤害不为“-”的由通常牌生成的《攻击》，若瞄准点位于该《攻击》的攻击距离内，则该《攻击》获得+1/+1。',
    ...
    special: [{
      ...
      types: ['enhance', 'reaction'],
      capacity: '3',
      text: '【展开时】若对于被对应的由通常牌生成的《攻击》，瞄准点位于该《攻击》的攻击距离内，则打消被对应的《攻击》，并将该牌封印于此牌下。\n【破弃时】将此牌所封印的所有牌置入对手的弃牌区。',
