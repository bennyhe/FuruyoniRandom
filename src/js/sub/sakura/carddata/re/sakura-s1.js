...
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      textjp: '【展開中】この付与札の上の桜花結晶がダストへと送られるならば、それは代わりに間合に動する。\n【展開中】達人の間合は1大きくなる。'
    },
    {
...
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      damage: '2/2',
      // text: '【攻击后】自命（1）→虚',
      textjp: '【攻撃後】あなたのライフが2以上ならば、自ライフ→ダスト：1'
    },
    {
...
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      textjp: 'マシンにある造花結晶 2 つを燃焼させてもよい。そうした場合、あなたは集中力を1得て、相手は集中力を1失い、相手を畏縮させる。 \nコストとして、集中力を2支払ってもよい。そうした場合、あなたの燃焼済の造花結晶を3つ回復する。'
    },
    {
...
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      textjp: '現在の風神ゲージに応じて、追加札から以下のカードを未使用で得る。その後、このカードを取り除く。\n3以上……風魔旋風 \n7以上……風魔纏廻 \n12以上……風魔天狗道\n(条件を満たしたものは全て得る)'
    },
    {
...
// },
{
  ...
  list: [{
    ...
    },
    {
      ...
      capacity: '2',
      cost: '4',
      textjp: '【展開中】この付与札の上の桜花結晶はメインフェイズに移動しない。開始フェイズの処理であなたの他の付与札から桜花結晶がよダストへと送られるならば、それは代わりにこの付与札の上に動かす。\n【展開中】この付与札の上の種結晶が5個になったターンの終了フェイズに、攻撃『適正距離5、5/5、不可避、【常時】この《攻撃》は打ち消されない』を行い、このカードの上の桜花結晶を全てダストに送る。'
    ...
    changespecial: [{
      ...
      cost: '2',
      text: '',
      textjp: '仮想樹と桜降る代を接ぐ。\nあなとの土壌の種結晶を一つ選び、それを仮想樹１に置く。\n【使用済】あなたのメインフェイズ、コストを支払わずにこのカードを使用してもよい。そうした場合、解決後にこのカードを取り除く。'
    }]
  }]
}
// {
