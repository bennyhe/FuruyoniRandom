...
},
{
  ...
  },
  {
    ...
    changenormal: [{
      ...
      textjp: 'あなたのマシンからTransFormカード1枚を追加札に戻してもよい。そうした場合、追加札からTransFormカード1枚をマシンに置く。(TransFormしたことにはならず、その【変形時】効果は発生しない)\n燃焼済の造花結晶を1つ回復するか、基本動作を1回行う。'
    }],
    changespecial: [{
      changeIndex: '1',
...
// },
{
  ...
  list: [{
    ...
    },
    {
      ...
      capacity: '2',
      capacityGrowup: '1',
      textjp: '生育 1\n【常時】Xは土壌以外にあるあなたの種結晶の個数の合計に等しい。\n【展開時】対応した《攻撃》は-X/+0となる。\n【展開中】相手の開始フェイズの開始時に攻撃『適正距離1ｰ6、0/1、【常時】この攻撃は+X/+0となる』を行う。'
