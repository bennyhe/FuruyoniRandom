...
const Sakura = [{
  ...
  list: [{
    ...
    {
      id: 're-01-yurina-o-n-5',
      name: '身法',
      namejp: '体捌き',
      baseType: 'normal',
      types: ['action'],
      text: '本回合内你的下一次《攻击》获得距离扩大（远1）。\n若自命中樱花结晶的数量小于敌命中樱花结晶的数量，则执行至多2次基本动作。',
      textjp: 'このターンにあなたが次に行う《攻撃》は距離拡大（遠1）を得る。\nあなたのライフが相手のライフよりも小さいならば、基本動作を2回まで行う。'
    },
    {
      id: 're-01-yurina-o-n-6',
      name: '气合斩',
      namejp: '圧気',
      baseType: 'normal',
      types: ['enhance'],
      capacity: '2',
      text: '破绽\n【展开时】每回合内，对手的第一次《攻击》获得-1/+0。\n【破弃时】进行一次“攻击距离1-3 伤害3/-”的攻击。',
      textjp: '隙\n【展開時】各ターンにおける相手の最初の《攻撃》は-1/+0となる。\n【破棄時】攻撃『適正距離1-3、3/-』を行う。'
    },
    {
      id: 're-01-yurina-o-n-7',
      name: '气焰万丈',
      namejp: '気炎万丈',
      baseType: 'normal',
...
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      textjp: '【展開中】この付与札の上の桜花結晶がダストへと送られるならば、それは代わりに間合に動がす。\n【展開中】達人の間合は1大きくなる。'
    },
    {
      id: 're-02-saine-o-n-6',
      name: '冲音晶',
      namejp: '衝音晶',
      baseType: 'normal',
      types: ['enhance', 'reaction'],
  ...
  },
  {
    ...
    changenormal: [{
      changeIndex: '1',
      id: 're-02/04-saine/tokoyo-a1-n-1/4',
      name: '合奏',
      namejp: '合奏',
      baseType: 'normal',
      types: ['attack', 'reaction'],
    ...
    },
    {
      ...
      textjp: '【展開中】八相ー相手が各ターンで初めて《攻撃》を行った時、あなたのオーラが1以下または他のメガミの切札が使用済ならば、その《攻撃》は対応不可を失い、-1/+0となる。\n【展開時/破棄時】サイネの切札が使用済ならば、このターン中あなたの切札の消費は1少なくなる。'
    }],
    changespecial: [{
      changeIndex: '2',
      id: 're-02-saine-a1-s-2',
      name: '二重奏：弹奏冰瞑',
      namejp: '二重奏：弾奏氷瞑',
      baseType: 'special',
      types: ['action'],
...
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      range: '2-8',
      damage: '2/2',
      text: '【攻击后】若自命中的樱花结晶的数目大于等于2，则自命（1）→距',
      textjp: '【攻撃後】あなたのライフが2以上ならば、自ライフ→間合：1'
    },
    {
      id: 're-03-himika-o-n-4',
      name: '完全爆破',
      namejp: 'フルバースト',
      baseType: 'normal',
      types: ['attack', 'fullpower'],
    ...
    {
      id: 're-03-himika-o-n-6',
      name: '回燃',
      namejp: 'バックドラフト',
      baseType: 'normal',
      types: ['action'],
      text: '对手畏缩。\n连火～若此牌为本回合内你使用的第3张或之后的牌，则本回合内你的其他女神的下一次对装伤害小于等于3的《攻击》获得+1/+1。',
      textjp: '相手を畏縮させる。\n連火-このカードがこのターンに使用した3枚目以降のカードならば、このターンにあなたが次に行う他のメガミによるオーラへのダメージが3以下の《攻撃》を+1/+1する。'
    },
    {
      id: 're-03-himika-o-n-7',
      name: '装弹',
      namejp: 'リローディング',
      baseType: 'normal',
      types: ['enhance'],
      capacity: '3',
      text: '【展开中】你的结束阶段开始时，若你的手牌张数为0，则你可以抓1张牌。',
      textjp: '【展開中】あなたの終了フェイズに手札が0枚ならば、カードを1枚引いてもよい。'
    }],
    special: [{
      id: 're-03-himika-o-s-1',
      name: '真红凶弹',
      namejp: 'レッドバレット',
      baseType: 'special',
      types: ['attack'],
...
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      range: '0-3',
      damage: '1/0',
      text: '【常时】境地～若你的集中力等于2，则此《攻击》获得+0/+1。\n【攻击后】虚（2）→距',
      textjp: '【常時】境地-あなたの集中力が2ならば、この《攻撃》は+0/+1となる。\n【攻撃後】ダスト→間合：2'
    },
    {
      id: 're-04-tokoyo-o-n-3',
      name: '雅击',
      namejp: '雅打ち',
      baseType: 'normal',
      types: ['attack', 'reaction'],
  ...
  },
  {
    ...
    changespecial: [{
      changeIndex: '3',
      id: 're-04-tokoyo-a1-s-3',
      name: '二重奏：吹弹阳明',
      namejp: '二重奏：吹弾陽明',
      baseType: 'special',
      types: ['action'],
      cost: '1',
      text: '【常时】境地~若你的集中力等于2，则此牌的费用减小1。\n本回合内，你不能支付集中力。\n【使用后】每当你使用其他女神的《对应》牌时，若当前为你的回合，则你可以执行1次基本动作《后退》或《离脱》；若当前为对手的回合，则对手畏缩。\n----\n【即再起】自命因被攻击受到了大于等于1点的伤害。',
      textjp: '【常時】境地ーあなたの集中力が2ならば、このカードの消費は1小さくなる。\nこのターン中、あなたは集中力を支払えない。\n【使用済】あなたが他のメガミの《対応》カードを使用した時、あなたのターンなら基本動作《後退》か《離脱》を1回行ってもよい。相手のターンなら相手を畏縮させる。\n------\n【即再起】あなたが《攻撃》によりライフに1以上のダメージを受ける。'
    }]
  }, {
    name: '恐怖',
    namejp: '恐怖',
...
},
{
  ...
  list: [{
    ...
    normal: [{
      ...
      range: '3-5',
      damage: '2/1',
      text: '设置\n【常时】若你从盖牌区中使用此牌，则此《攻击》获得+0/+1。',
      textjp: '設置\n【常時】このカードを伏せ札から使用したならば、この《攻撃》は+0/+1となる。'
    },
    {
      id: 're-05-oboro-o-n-2',
      name: '影菱',
      namejp: '影菱',
      baseType: 'normal',
      types: ['attack'],
      range: '2-3',
      damage: '2/1',
      text: '设置 不可被对应 \n【攻击后】若你从盖牌区使用此牌，则对手畏缩。',
      textjp: '設置　対応不可\n【攻撃後】このカードを伏せ札から使用したならば、相手を畏縮させる。'
    },
    {
      id: 're-05-oboro-o-n-3',
      name: '分身术',
      namejp: '分身の術',
      baseType: 'normal',
      types: ['attack'],
      range: '3-4',
      damage: '2/1',
      text: '【攻击后】你可以盖伏1张手牌。若如此做，则进行一次“攻击距离3-4，伤害1/1”的攻击，并执行1次基本动作《装附》。',
      textjp: '【攻撃後】手札を1枚伏せ札にしてもよい。そうした場合、攻撃『適正距離3-4、1/1』を行い、基本動作《纏い》を1回行う。'
    },
    {
      id: 're-05-oboro-o-n-4',
      name: '斩击乱舞',
      namejp: '斬撃乱舞',
      baseType: 'normal',
      types: ['attack', 'fullpower'],
  ...
  },
  {
    ...
    changeExtra: [{
      id: 're-05-oboro-a1-s-4-ex1',
      name: '最后的结晶',
      namejp: '最後の結晶',
      baseType: 'special',
      extraFrom: 're-05-oboro-a1-s-4',
      types: ['action'],
      cost: '3',
  ...
  },
  {
    ...
    changespecial: [{
      ...
      damage: '2/2',
      cost: '16',
      text: '不可被对应\n【常时】此牌的费用减小X，X等于你的盖牌张数与已组装的零件数之和。\n【攻击后】进行2次“攻击距离3-4 伤害2/2”的攻击。',
      textjp: '対応不可\n【常時】このカードの消費はあなたの伏せ札の枚数と組み立てられたパーツの数の合計だけ少なくなる。\n【攻撃後】攻撃『適正距離3-4、2/2』を2回行う。'
    }, {
      changeIndex: '3',
      id: 're-05-oboro-a2-s-3',
      name: '胧文书·电子神涉',
      namejp: '朧文書・電子神渉',
      baseType: 'special',
      types: ['action', 'fullpower'],
    ...
    changeExtra: [{
      ...
      id: 're-05-oboro-a2-cp-1',
      name: '自定义零件A',
      namejp: 'カスタムパーツA',
      text: '一：不可被对应（《付与》牌）\n二：不可被对应（《攻击》牌）\n三：不可被对应（《行动》牌）\n四：不可被对应（通常牌）',
      textjp: '壱：対応不可（《付与》）\n弐：対応不可（《攻撃》）\n参：対応不可（《行動》）\n肆：対応不可（通常札）'
    }, {
      id: 're-05-oboro-a2-cp-2',
      name: '自定义零件B',
      namejp: 'カスタムパーツB',
      text: '一：【常时】此《攻击》获得+0/+0。\n二：【常时】此《攻击》获得+0/+1。\n三：【常时】此《攻击》获得+1/+0。\n四：【常时】此《攻击》获得+1/+1。',
      textjp: '壱：【常時】この《攻撃》は+0/+0となる。\n弐：【常時】この《攻撃》は+0/+1となる。\n参：【常時】この《攻撃》は+1/+0となる。\n肆：【常時】この《攻撃》は+1/+1となる。'
    }, {
      id: 're-05-oboro-a2-cp-3',
      name: '自定义零件C',
      namejp: 'カスタムパーツC',
      text: '一：【攻击后】虚（1）→距\n二：【攻击后】虚（1）⇔距\n三：【攻击后】虚（1）⇔距\n四：【攻击后】虚（1）⇔距\n你获得1点集中力。',
      textjp: '壱：【攻撃後】ダスト→間合：１\n弐：【攻撃後】ダスト↔間合：１\n参：【攻撃後】ダスト↔間合：１\n肆：【攻撃後】ダスト↔間合：１\nあなたは集中力を1得る。'
    }, {
      id: 're-05-oboro-a2-cp-4',
      name: '自定义零件D',
      namejp: 'カスタムパーツD',
...
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      capacity: '5',
      cost: '2',
      text: '闭伞：终端\n【展开中】你的回合内，你进行的第一次《攻击》获得距离扩大（近1）与+0/+1。\n开伞：终端\n【展开中】你的回合内，你进行的第一次《攻击》获得距离扩大（远1）与+1/+0。',
      textjp: '閉；終端 \n【展開中】あなたのターンにあなたが初めて行う《攻撃》は距離拡大（近1）を得て、+0/+1となる。 \n開；終端 \n【展開中】あなたのターンにあなたが初めて行う《攻撃》は距離拡大（遠1）を得て、+1/+0となる。'
    },
    {
      id: 're-06-yukihi-o-s-4',
      name: '复返其身',
      namejp: 'くるりみ',
      baseType: 'special',
      types: ['action', 'reaction'],
...
},
{
  ...
  list: [{
    ...
    {
      id: 're-07-shinra-o-n-7',
      name: '论破',
      namejp: '論破',
      baseType: 'normal',
      types: ['enhance', 'reaction'],
      capacity: '3',
      text: '【展开时】弃置对手牌库顶的1张牌。从对手的弃牌中选择1张牌，封印于此牌下。\n【破弃时】将此牌所封印的所有牌置入对手的弃牌区。',
      textjp: '【展開時】相手の山札の上から1枚を捨て札にする。相手の捨て札にあるカードを1枚選び、このカードの下に封印する。\n【破棄時】このカードに封印されたカードを相手の捨て札に戻す。'
    }],
    special: [{
      id: 're-07-shinra-o-s-1',
      name: '完全论破',
      namejp: '完全論破',
      baseType: 'special',
      types: ['action'],
    ...
    },
    {
      ...
      textjp: '計略を実行し、次の計略を準備する。 \n[神算] あなたの捨て札または使用済の切札から、《付与》カードを1枚選び、消費を支払わずにそれを使用する。そのカードが《全力》ならば現在のフェイズを終了する。 \n[鬼謀] 切札でない相手の付与札を1枚選ぶ。その上の桜花結晶全てをダストに送る。',
      textkururu: [{
        ctn: '实行当前计略，准备下个计略。'
      }, {
        if: '<i class="i-bean i-bean--plan-blue"></i>',
      ...
      textkururujp: [{
        ...
        if: '<i class="i-bean i-bean--plan-blue"></i>',
        ctn: '[神算] あなたの捨て札または使用済の切札から、《付与》カードを1枚選び、消費を支払わずにそれを使用する。そのカードが《全力》ならば現在のフェイズを終了する。 '
      }, {
        if: '<i class="i-bean i-bean--plan-red"></i>',
...
},
{
  ...
  namejp: 'ハガネ',
  nameen: 'HAGANE',
  desc: '远心～仅当同时满足以下2个条件时，可以使用具远心关键字的牌：<br>1.当前距离比回合开始时的距离远2及以上；<br>2.当前阶段内你没有进行过《攻击》。',
  descjp: '遠心～以下の2つを共に満たしている場合のみ、遠心を持つカードは使用できる。<br>1.現在の間合がターン開始時の間合から2以上離れている。<br>2.現在のフェーズにあなたが《攻撃》を行っていない。',
  ...
  list: [{
    ...
    },
    {
      ...
      range: '0-6',
      damage: '1/-',
      text: '【攻击后】若当前距离与本回合开始时距离之差的绝对值大于等于2，则对手弃1张牌。',
      textjp: '【攻撃後】現在の間合がターン開始時の間合から2以上変化しているならば、相手は手札を1枚捨て札にする。'
    },
    {
      id: 're-08-hagane-o-n-3',
      name: '大地碎击',
      namejp: '大地砕き',
      baseType: 'normal',
      types: ['attack', 'fullpower'],
    ...
    },
    {
      ...
      capacity: '2',
      text: '【展开时】距（1）→自装\n【破弃时】自装（1）→距',
      textjp: '【展開時】間合→自オーラ：1\n【破棄時】自オーラ→間合：1'
    }],
    special: [{
      id: 're-08-hagane-o-s-1',
      name: '大天空·破限',
      namejp: '大天空クラッシュ',
      baseType: 'special',
      types: ['attack'],
    ...
    {
      id: 're-08-hagane-o-s-2',
      name: '大破钟·断限',
      namejp: '大破鐘メガロベル',
      baseType: 'special',
      types: ['action', 'reaction'],
      cost: '2',
      text: '若你的其他王牌均处于使用后状态，则距（1）→自命\n结算完毕后将此牌移出游戏。',
      textjp: 'あなたの他の切札が全て使用済ならば、間合→自ライフ：1\nこのカードを取り除く。'
    },
    {
      id: 're-08-hagane-o-s-3',
      name: '大重力·无限',
      namejp: '大重力アトラクト',
      baseType: 'special',
      types: ['action'],
  ...
  },
  {
    ...
    changeExtra: [{
      id: 're-08-hagane-a1-s-1-ex1',
      name: '炼成攻击',
      namejp: '錬成攻撃',
      baseType: 'normal',
      extraFrom: 're-08-hagane-a1-s-1',
      types: ['variable'],
      text: '【常时】此牌为铁砧上的牌之复制，但其名称、使用者与此效果保持不变。若此牌在手牌中，则此牌不可被对手选择为效果的目标。若此牌不在手牌与盖牌区中，则无法因重铸牌库以外的效果移动至牌库或手牌。此牌不可被封印。根据铁砧上的樱花结晶的数目，此《攻击》获得以下效果。\n大于等于0……+1/+0和距离扩大（远1）\n大于等于1……+0/+1和距离扩大（远1）\n大于等于2……+1/+1、距离扩大（远1）和“【常时】此《攻击》不可被打消。”',
      textjp: '【常時】このカードは名前、使用者とこの効果を除き金床にあるカードの複製になる。このカードは封印されず、手札にあるなら相手の効果で相手によって選ばれず、手札か伏せ札にないなら山札の再構成以外で山札や手札に戻らない。金床にある桜花結晶の個数に応じて以下の効果を得る。\n0以上……+1/+0となり、距離拡大（遠1）を得る。\n1以上……+0/+1となり、距離拡大（遠1）を得る。\n2以上……+1/+1となり、距離拡大（遠1）を得る、打ち消されない。'
    }]
  }]
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      capacity: '3',
      cost: '3',
      text: '【展开中】对于双方的所有的《攻击》，若其对命伤害不为"-"，则将其对装伤害变为对命伤害。\n（例如3/1会变成1/1、1/2会变成2/2。若有多个将伤害变为指定值的效果，则先结算该《攻击》自身的效果）',
      textjp: '【展開中】ライフへのダメージが「-」でないお互いの《攻撃》において、オーラへのダメージは、ライフへのダメージの値に等しくなる。\n（例えば3/1は1/1のように、1/2は2/2のように扱う。代入が重複するならば、その《攻撃》自体の代入する効果を先に適用する）'
    },
    {
      id: 're-09-chikage-o-s-3',
      name: '霞毒空流转',
      namejp: '流転の霞毒',
      baseType: 'special',
      types: ['attack'],
...
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      textkururu: [{
        ...
        if: '<i class="i-bean i-bean--blue"></i><i class="i-bean i-bean--blue"></i>',
        ctn: '对敌气造成1点伤害'
      }, {
    ...
    {
      id: 're-10-kururu-o-n-5',
      name: '回嗖利用',
      namejp: 'りげいなー',
      baseType: 'normal',
      types: ['action', 'fullpower'],
      text: '机巧：绿紫～你可以从弃牌、盖牌或使用后的王牌中选择至多1张其他女神的非《全力》牌使用，而无需支付其费用。此时你可以从该牌的攻击距离集合、对装伤害、对命伤害或纳中选择一项，所选项的所有值增大或减小1。\n----\n【常时】你可以从盖牌区由主要阶段的规则效果使用此牌。',
      textjp: '<付対> 捨て札、伏せ札、切札のいずれかから未使用でも《全力》でもない他のメガミのカードを1枚まで選び、コストを支払わずにそれを使用してもよい。その際、適正距離の全ての値、どちらかのダメージ、納のいずれかを1増減させてもよい。\n----\n【常時】このカードは伏せ札から手札にあるかのように通常の方法で使用できる。',
      textkururu: [{
        if: '<i class="i-bean i-bean--green"></i><i class="i-bean i-bean--purple"></i>',
        ctn: '你可以从弃牌、盖牌或使用后的王牌中选择至多1张其他女神的非《全力》牌使用，而无需支付其费用。此时你可以从该牌的攻击距离集合、对装伤害、对命伤害或纳中选择一项，所选项的所有值增大或减小1。'
      }, {
        ctn: '【常时】你可以从盖牌区由主要阶段的规则效果使用此牌。'
      }],
      textkururujp: [{
        if: '<i class="i-bean i-bean--green"></i><i class="i-bean i-bean--purple"></i>',
        ctn: '捨て札、伏せ札、切札のいずれかから未使用でも《全力》でもない他のメガミのカードを1枚まで選び、コストを支払わずにそれを使用してもよい。その際、適正距離の全ての値、どちらかのダメージ、納のいずれかを1増減させてもよい。'
      }, {
        ctn: '【常時】このカードは伏せ札から手札にあるかのように通常の方法で使用できる。'
      }]
    },
    {
      id: 're-10-kururu-o-n-6',
      name: '模块化',
      namejp: 'もじゅるー',
      baseType: 'normal',
      types: ['enhance'],
    ...
    special: [{
      ...
      textjp: '相オーラ→自オーラ：1 \n【使用済】あなたの使用済の切札が未使用に戻った時、消費を支払わずにこのカードを使用してもよい。'
    },
    {
      id: 're-10-kururu-o-s-2',
      name: '大魔像',
      namejp: 'びっぐごーれむ',
      baseType: 'special',
      types: ['action'],
    ...
    {
      id: 're-10-kururu-o-s-4',
      name: '神涉装置：枢式',
      namejp: '神渉装置：枢式',
      baseType: 'special',
      types: ['action'],
      cost: '3',
      text: '机巧：红红蓝蓝蓝绿绿～检视对手的王牌。你可以从中选择1张处于未使用状态的牌，将其变为使用后状态。\n你可以从对手的处于使用后状态的王牌中选择至多1张。使用所选择的牌，而不需支付自气中的樱花结晶（可以选择具《全力》副类别的牌）。\n结算完毕后将此牌移出游戏。',
      ...
      textkururu: [{
        ...
        ctn: '你可以从对手的处于使用后状态的王牌中选择至多1张。使用所选择的牌，而不需支付自气中的樱花结晶（可以选择具《全力》副类别的牌）。\n结算完毕后将此牌移出游戏。'
      }],
      textkururujp: [{
        if: '<i class="i-bean i-bean--red"></i><i class="i-bean i-bean--red"></i><i class="i-bean i-bean--blue"></i><i class="i-bean i-bean--blue"></i><i class="i-bean i-bean--blue"></i><i class="i-bean i-bean--green"></i><i class="i-bean i-bean--green"></i>',
        ctn: '相手の切札を見て、その中から1枚選び、それを使用済にしてもよい。'
      }, {
        ctn: '相手の使用済の切札を1枚まで選び、消費を支払わずにそれを使用してもよい(《全力》カードでもよい)。\nその後、このカードを取り除く。'
      }]
    }],
    extra: [{
      id: 're-10-kururu-o-s-3-ex1',
      name: '复制品齿轮',
      namejp: 'でゅーぷりぎあ',
      baseType: 'normal',
      extraFrom: 're-10-kururu-o-s-3',
      types: ['variable'],
      text: '（牌类别为不定的牌不能使用）\n【常时】此牌为被『复自黏贴』封印的牌之复制，但名称仍为『复制品齿轮』（『复自黏贴』没有封印牌时不触发复制，故不能使用此牌）。',
      textjp: '(カードタイプが不定のカードは使用できない) \n【常時】このカードはあなたの「いんだすとりあ」に封印されたカードの複製となる。ただし、名前は変更されない。 \n(「いんだすとりあ」が未使用なら複製とならないので、使用できない)'
    },
    {
      id: 're-10-kururu-o-s-3-ex1',
      name: '复制品齿轮',
  ...
  },
  {
    ...
    changespecial: [{
      changeIndex: '3',
      id: 're-10-kururu-a1-s-3',
      name: '不懈探索',
      namejp: 'らすとりさーち',
      baseType: 'special',
      types: ['action'],
      cost: '2',
      text: '机巧～红：若对手盖牌区的牌张数为0，则盖伏对手牌库顶的1张牌。对手从其盖牌中选择1张牌。你宣言1个牌名，并将所选择的牌置入弃牌区。若你宣言的牌名与所选择的一张牌的牌名一致，则将1个樱花结晶从游戏外移至此牌上。然后若此牌上的樱花结晶的数目变为2，则进行世纪的大发现（查看对手的所有王牌。然后选择你或者对手，将该玩家眼前构筑时未选用的所有王牌从游戏外以未使用状态加入王牌。将『不懈探索』及其上的樱花结晶移出游戏并将『壮绝旅途』从追加牌区以未使用状态加入王牌。）。\n【使用后】每当你重铸牌库时，或每当你使用具《全力》副类别的牌时，该回合的结束阶段开始时你可以使用此牌，而无需支付其费用。',
      ...
      textkururu: [{
        ...
        ctn: '若对手盖牌区的牌张数为0，则盖伏对手牌库顶的1张牌。对手从其盖牌中选择1张牌。你宣言1个牌名，并将所选择的牌置入弃牌区。若你宣言的牌名与所选择的一张牌的牌名一致，则将1个樱花结晶从游戏外移至此牌上。然后若此牌上的樱花结晶的数目变为2，则进行世纪的大发现（查看对手的所有王牌。然后选择你或者对手，将该玩家眼前构筑时未选用的所有王牌从游戏外以未使用状态加入王牌。将『不懈探索』及其上的樱花结晶移出游戏并将『壮绝旅途』从追加牌区以未使用状态加入王牌。）。'
      }, {
    ...
    changeExtra: [{
      id: 're-10-kururu-a1-s-3-ex1',
      name: '壮绝旅途',
      namejp: 'ぐらんがりばー',
      baseType: 'special',
      extraFrom: 're-10-kururu-a1-s-3',
      types: ['action'],
      cost: 'X',
  ...
  },
  {
    ...
    changenormal: [{
      ...
      range: '2-6',
      damage: '1/2',
      text: '机巧：红红～【常时】进行此《攻击》时，此《攻击》获得+1/+0。\n机巧：黄～终端\n【常时】进行此《攻击》时，此《攻击》获得+1/+1和不可被打消。',
      textjp: '<攻攻>【常時】この《攻撃》が行われた時、この《攻撃》は+1/+0となる。\n<全>終端\n【常時】この《攻撃》が行われた時、この《攻撃》は+1/+1となり、打ち消されない。',
      textkururu: [{
        if: '<i class="i-bean i-bean--red"></i><i class="i-bean i-bean--red"></i>',
        ctn: '【常时】进行此《攻击》时，此《攻击》获得+1/+0。'
      }, {
      ...
      textkururujp: [{
        if: '<i class="i-bean i-bean--red"></i><i class="i-bean i-bean--red"></i>',
        ctn: '【常時】この《攻撃》が行われた時、この《攻撃》は+1/+0となる。'
      }, {
        if: '<i class="i-bean i-bean--yellow"></i>',
        ctn: '終端\n【常時】この《攻撃》が行われた時、この《攻撃》は+1/+1となり、打ち消されない。'
      }]
    ...
    changespecial: [{
      ...
      textjp: '<付行対>【使用時/使用済】他のメガミのカードで組み立てたならば、使用時とあなたの終了フェイスにタストまたはあなたのオーラからこのカードの上に桜花結晶を1つ置いてもよい。\n【使用済】あなたがある歯車枠の効果を解決するに際し、このカードの上の桜花結晶を1つタストに送ってもよい。そうした場合、その歯車枠の中に書かれた数字全てを2倍にする。',
      textkururu: [{
      ...
      textkururujp: [{
        if: '<i class="i-bean i-bean--green"></i><i class="i-bean i-bean--blue"></i><i class="i-bean i-bean--purple"></i>',
        ctn: '【使用時/使用済】他のメガミのカードで組み立てたならば、使用時とあなたの終了フェイスにタストまたはあなたのオーラからこのカードの上に桜花結晶を1つ置いてもよい。'
      }, {
        ctn: '【使用済】あなたがある歯車枠の効果を解決するに際し、このカードの上の桜花結晶を1つタストに送ってもよい。そうした場合、その歯車枠の中に書かれた数字全てを2倍にする。'
      }]
    }]
  }]
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      range: '2-7',
      damage: '1/1',
      text: '【攻击后】你可以进行一次骑动。然后你可以从弃牌区中选择至多1张其他女神的非《全力》的《攻击》牌使用。',
      textjp: '【攻撃後】騎動を行ってもよい。その後、捨て札から他のメガミの《全力》でない《攻撃》カードを１枚まで選び、それを使用してもよい。'
    },
    {
      id: 're-11-thallya-o-n-6',
      name: 'Roaring',
      namejp: 'Roaring',
      baseType: 'normal',
      types: ['action'],
      text: '若你的引擎中有至少2个处于未燃烧状态的造花结晶，则你可以燃烧2个造花结晶。若如此做，则你获得1点集中力，敌气（1）→虚\n你可以支付2点集中力。若如此做，则回复3个处于燃尽状态的造花结晶。',
      textjp: 'マシンにある造花結晶2つを燃焼させてもよい。そうした場合、あなたは集中力を1得て、相フレア→ダスト：1\n集中力を2支払ってもよい。そうした場合、あなたの燃焼済の造花結晶を3つ回復する。'
    },
    {
      id: 're-11-thallya-o-n-7',
      name: 'Turbo Switch',
      namejp: 'Turbo Switch',
      baseType: 'normal',
      types: ['action', 'reaction'],
    ...
    {
      id: 're-11-thallya-o-tf-2',
      name: 'Form: NAGA',
      namejp: 'Form: NAGA',
      baseType: 'transform',
      types: ['transform'],
      text: '【变形时】若敌气中的樱花结晶的数目大于等于3，则保留其中2个樱花结晶，其余移至虚。\n【追加基本动作】Gamma - Ray：弃置对手的牌库顶的1张牌。',
      textjp: '【変形時】相手のフレアが3以上ならば、相手のフレアが2になるように桜花結晶をダストへ移動させる。\n----\n【追加基本行動：Gamma-Ray】\n相手の山札の上から1枚を捨て札にする。'
    },
    {
      id: 're-11-thallya-o-tf-3',
      name: 'Form: GARUDA',
      namejp: 'Form: GARUDA',
      baseType: 'transform',
      types: ['transform'],
  ...
  },
  {
    ...
    changenormal: [{
      changeIndex: '5',
      id: 're-11-thallya-a1-n-5',
      name: 'Quick Change',
      namejp: 'Quick Change',
      baseType: 'normal',
      types: ['action'],
      text: '你可以从你的引擎中将1张变形牌移回追加牌区。若如此做，则将1张变形牌从追加牌区移至引擎。\n（此效果不视为TRANSFORM，也不触发【变形时】效果）\n回复1个处于燃尽状态的造花结晶，或执行1次基本动作。',
      textjp: 'あなたのマシンからTransFormカード1枚を追加札に戻してもよい。そうした場合、追加札からTransFormカード1枚をマシンに置く。\n(TransFormしたことにはならず、その【変形時】効果は発生しない)\n燃焼済の造花結晶を1つ回復するか、基本動作を1回行う。'
    }],
    changespecial: [{
      changeIndex: '1',
      id: 're-11-thallya-a1-s-1',
      name: 'BlackBox NEO',
      namejp: 'BlackBox NEO',
      baseType: 'special',
      types: ['action'],
...
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      textjp: '【攻撃後】捨て札にある《攻撃》カード1枚を選び、山札の一番上に置いてもよい。'
    },
    {
      id: 're-12-raira-o-n-4',
      name: '疾风步',
      namejp: '風走り',
      baseType: 'normal',
      types: ['action'],
    ...
    {
      id: 're-12-raira-o-n-5',
      name: '风雷的知慧',
      namejp: '風雷の知恵',
      baseType: 'normal',
      types: ['action'],
      text: '获得1点集中力。\n若风神槽与雷神槽的值之和大于等于4，则你可以从弃牌中选择至多1张其他女神的牌，将其置于你的牌库顶。\n若风神槽与雷神槽的值之和大于等于12，则重铸你的牌库，抓1张牌，然后将此牌移出游戏。',
      textjp: '集中力を1得る。\n風神ゲージと雷神ゲージの合計が4以上ならば、捨て札にある他のメガミのカードを1枚まで選び、山札の一番上に置いてもよい。\n12以上ならば、山札を再構成してカードを１枚引き、このカードを取り除く。'
    },
    {
      id: 're-12-raira-o-n-6',
      name: '吼叫',
      namejp: '呼び声',
      baseType: 'normal',
      types: ['action', 'fullpower'],
      text: '选择1项：\n1.风神槽与雷神槽的值各增加1，对手畏缩；\n2.雷神槽的值变为原本的2倍。\n然后，若风神槽与雷神槽的值之和大于等于12，则执行至多2次基本动作。',
      textjp: '以下から1つを選ぶ。\n・風神ゲージと雷神ゲージを１ずつ上げ、相手を畏縮させる。\n・雷神ゲージを2倍にする。\nその後、風神ゲージと雷神ゲージの合計が12以上ならば、基本動作を２回まで行う。'
    },
    {
      id: 're-12-raira-o-n-7',
      name: '驭空术',
      namejp: '空駆け',
      baseType: 'normal',
      types: ['action', 'fullpower'],
    ...
    special: [{
      ...
      textjp: '【常時】雷神ケージが4以上ならば、この《攻撃》は+1/+0となる。 \n----\n【再起】風神ケージが4以上である。'
    },
    {
      id: 're-12-raira-o-s-2',
      name: '天雷召唤阵',
      namejp: '天雷召喚陣',
      baseType: 'special',
      types: ['action', 'fullpower'],
    ...
    },
    {
      ...
      textjp: '現在の風神ゲージに応じて、追加札から以下のカードを未使用で得る。その後、このカードを取り除く。3以上……「風魔旋風」 \n7以上……「風魔纏廻」\n12以上……「風魔天狗道」\n(条件を満たしたものは全て得る)'
    },
    {
      id: 're-12-raira-o-s-4',
      name: '圆环轮回旋',
      namejp: '円環輪廻旋',
      baseType: 'special',
      types: ['enhance', 'reaction'],
      ...
      textjp: '【展開中】相手の《攻撃》の解決後に以下を全て行ってもよい。\n・ダスト⇔間合：1 \n・風神ゲージか雷神ゲージを1上げる。'
    }],
    extra: [{
      id: 're-12-raira-o-s-3-ex1',
      name: '风魔旋风',
      namejp: '風魔旋風',
      baseType: 'special',
      extraFrom: 're-12-raira-o-s-3',
      types: ['attack'],
      range: '1-3',
      damage: '1/2',
      cost: '1',
  ...
  },
  {
    ...
    changespecial: [{
      changeIndex: '3',
      id: 're-12-raira-a1-s-3',
      name: '阵风祭天式',
      namejp: '陣風祭天儀',
      baseType: 'special',
      types: ['action'],
      cost: '2',
      text: '风神槽和雷神槽各增加2，对手畏缩。\n【使用后】你的风神槽和雷神槽的值不能增加。\n【使用后】你的主要阶段开始时，若你选择执行标准行动，则你可以使用至多2次岚之力，但不能使用同一种岚之力2次。',
      textjp: '風神ゲージと雷神ゲージを2ずつ上げ、相手を畏縮させる。\n【使用済】風神ゲージと雷神ゲージは増加しない。\n【使用済】あなたのメインフェイズの開始時に、標準行動を選択したならば、嵐の力を2回まで使用してもよい。ただし、同じ力は選べない。'
    }],
    girlBoard: [{
      id: 're-12-raira-a1-st',
      name: '【岚之力】',
      namejp: '【嵐の力】',
      baseType: '',
      types: ['extra'],
...
//     }],
//     changeExtra: [{
//       id: 're-13-utsuro-a1-s-1-ex1',
//       name: '夙愿',
//       namejp: '望我',
//       baseType: 'special',
//       extraFrom: 're-13-utsuro-a1-s-1',
//       types: ['action'],
//       cost: '6',
//       text: '【使用后】你不会受到伤害。\n----\n【即再起】你的主要阶段开始时。',
...
//     },
//     {
//       id: 're-14-honoka-o-n-5',
//       name: '樱花护身符',
//       namejp: '桜花のお守り',
//       baseType: 'normal',
//       types: ['action', 'reaction'],
//       text: '你可以从手牌中选择1张牌并盖伏。若如此做，则打消被对应的非王牌的《攻击》。\n开花～你可以将这张『樱花护身符』与追加牌区中的『暗淡余辉』交换。若如此做，则你可以将『暗淡余辉』置于你的牌库底。',
...
//     }],
//     extra: [{
//       id: 're-14-honoka-o-n-1-ex1',
//       name: '守护灵式',
//       namejp: '守護霊式',
//       baseType: 'normal',
//       extraFrom: 're-14-honoka-o-n-1',
//       types: ['attack', 'reaction'],
//       range: '2-3',
//       damage: '2/1',
...
//     },
//     {
//       id: 're-14-honoka-o-n-1-ex2',
//       name: '突击灵式',
//       namejp: '突撃霊式',
//       baseType: 'normal',
//       extraFrom: 're-14-honoka-o-n-1-ex1',
//       types: ['attack'],
//       range: '5',
//       damage: '3/2',
...
//     },
//     {
//       id: 're-14-honoka-o-n-1-ex3',
//       name: '神灵奥华',
//       namejp: '神霊ヲウカ',
//       baseType: 'normal',
//       extraFrom: 're-14-honoka-o-n-1-ex2',
//       types: ['attack', 'fullpower'],
//       range: '1-4',
//       damage: '4/3',
//       text: '不可被对应\n【攻击后】虚（2）→自装',
...
//     },
//     {
//       id: 're-14-honoka-o-n-4-ex1',
//       name: '再生',
//       namejp: '再生',
//       baseType: 'normal',
//       extraFrom: 're-14-honoka-o-n-4',
//       types: ['action', 'fullpower'],
//       text: '虚（1）→自装\n虚（1）→自气\n将这张『再生』与追加牌区中的『樱之翅』交换。',
//       textjp: 'ダスト→自オーラ：1 \nダスト→自フレア：1 \nこの「再生」を追加札の「桜の翅」と交換する。'
//     },
//     {
//       id: 're-14-honoka-o-n-5-ex1',
//       name: '暗淡余辉',
//       namejp: '仄かなる輝き',
//       baseType: 'normal',
//       extraFrom: 're-14-honoka-o-n-5',
//       types: ['attack'],
//       range: '1-3',
//       damage: '1/2',
//       text: '',
...
//     },
//     {
//       id: 're-14-honoka-o-s-1-ex1',
//       name: '结樱于手',
//       namejp: '両手に華を',
//       baseType: 'special',
//       extraFrom: 're-14-honoka-o-s-1',
//       types: ['action', 'fullpower'],
//       cost: '0',
...
//     },
//     {
//       id: 're-14-honoka-o-s-1-ex2',
//       name: '旋即旌招幕展',
//       namejp: 'そして新たな幕開けを',
//       baseType: 'special',
//       extraFrom: 're-14-honoka-o-s-1-ex1',
//       types: ['action'],
//       cost: '5',
...
//     }],
//     changeExtra: [{
//       id: 're-14-honoka-a1-n-1-ex1',
//       extraFrom: 're-14-honoka-a1-n-1',
//       name: '影之两手',
//       namejp: '影の両手',
//       baseType: 'normal',
//       types: ['attack'],
...
//     }, {
//       id: 're-14-honoka-a1-s-1-ex1',
//       extraFrom: 're-14-honoka-a1-s-1',
//       name: '循迹访清荧',
//       namejp: '標をたどり',
//       baseType: 'normal',
//       types: ['action'],
...
//     }, {
//       id: 're-14-honoka-a1-s-1-ex3',
//       extraFrom: 're-14-honoka-a1-s-1-ex1',
//       name: '熠熠见繁樱',
//       namejp: '桜花眩く輝かん',
//       baseType: 'special',
//       types: ['attack'],
...
//     }, {
//       id: 're-14-honoka-a1-s-1-ex4',
//       extraFrom: 're-14-honoka-a1-s-1-ex2',
//       name: '觫觫结袂情',
//       namejp: 'ふたり震える手を取ろう',
//       baseType: 'special',
//       types: ['action'],
...
// },
{
  ...
  list: [{
    ...
    namejp: '試練',
    isSelect: false,
    pic: 'twiicon_sa_52t.jpg',
    picq: 'sd_korunu_a1.png',
    changenormal: [{
      changeIndex: 6,
      id: 're-15-korunu-a1-n-6',
      name: '冰凌包覆',
      namejp: '氷柱衾',
      types: ['enhance', 'fullpower'],
      capacity: '0',
      text: '【展开时】将5个樱花结晶从虚移至此牌上，然后冻结自己，直至自装中没有空位为止。若以此法冻结了自己至少2次，则进行一次“攻击距离2-5 伤害2/2 不可被对应（通常牌）”的攻击。\n【展开中】当你结算伤害时，自装中的冻结指示物视为樱花结晶。',
      textjp: '【展開時】このカードの上に桜花結晶を5個ダストから置き、あなたはオーラの空きがなくなるまで凍結する。この効果により2回以上凍結したならば、攻撃『適正距離2-5、2/2、対応不可(通常札)』を行う。\n【展開中】あなたへのダメージを解決するに際し、オーラにある凍結トークンを桜花結晶としても扱う。'
    }],
    changespecial: [{
      changeIndex: 1,
      ...
      damage: '2/2',
      cost: '2',
      text: '【攻击后】冻结自己1次。若以此法放置了冻结指示物，则冻结对手1次。\n----\n【再起】敌装中的冻结指示物的数目小于自装中的冻结指示物的数目。',
      textjp: '【攻撃後】あなたは１回凍結する。これにより凍結トークンが置かれたならば、相手は１回凍結する。\n----\n【再起】相手のオーラにある凍結トークンがあなたのオーラにある凍結トークンより少ない。'
    }, {
      changeIndex: 3,
      ...
      capacity: '3',
      cost: '3',
      text: '【常时】此牌的牌面费用减小X并增大Y，X为双方装中冻结指示物的总数，Y为敌命中樱花结晶的数目。\n【常时】使用此牌时，不将从自气中支付的樱花结晶移至虚，而改为移至此牌上。\n【破弃时】对手输掉本局游戏。',
      textjp: '【常時】このカードの消費はお互いのオーラにある凍結トークンの数の合計だけ少なくなり、相手のライフの数だけ多くなる。\n【常時】このカードの消費の支払いにより移動する桜花結晶はダストではなくこのカードの上に動かす。\n【破棄時】相手は敗北する。'
    }]
  }]
},
// {
...
//     }],
//     changeExtra: [{
//       id: 're-16-yatsuha-a1-n-1-ex1',
//       extraFrom: 're-16-yatsuha-o-n-1',
//       name: '星辰之利爪',
//       namejp: '星辰の鉤爪',
//       baseType: 'normal',
//       types: ['attack'],
...
//     }, {
//       id: 're-16-yatsuha-a1-n-2-ex1',
//       extraFrom: 're-16-yatsuha-o-n-2',
//       name: '深渊之巨吻',
//       namejp: '深淵の大口',
//       baseType: 'normal',
//       types: ['attack'],
...
//     }, {
//       id: 're-16-yatsuha-a1-n-3-ex1',
//       extraFrom: 're-16-yatsuha-o-n-3',
//       name: '现世之魔物',
//       namejp: '本当の怪物',
//       baseType: 'normal',
//       types: ['attack', 'fullpower'],
...
//     }, {
//       id: 're-16-yatsuha-a1-n-4-ex1',
//       extraFrom: 're-16-yatsuha-o-n-4',
//       name: '幻影联动',
//       namejp: '幻影連携',
//       baseType: 'normal',
//       types: ['action'],
...
//     }, {
//       id: 're-16-yatsuha-a1-n-5-ex1',
//       extraFrom: 're-16-yatsuha-o-n-5',
//       name: '决意',
//       namejp: '決意',
//       baseType: 'normal',
//       types: ['action', 'reaction'],
...
//     }, {
//       id: 're-16-yatsuha-a1-n-6-ex1',
//       extraFrom: 're-16-yatsuha-o-n-6',
//       name: '盟约',
//       namejp: '盟約',
//       baseType: 'normal',
//       types: ['action', 'reaction'],
...
//       textjp: '以下から1つを選ぶ。\n・相オーラ↔自フレア：1。\n・相フレア↔自オーラ：1。'
//     }, {
//       id: 're-16-yatsuha-a1-n-7-ex1',
//       extraFrom: 're-16-yatsuha-o-n-7',
//       name: '徒寄花',
//       namejp: '徒寄花',
//       baseType: 'normal',
//       types: ['enhance'],
...
//     changeExtra: [
//       {
//         id: 're-16-yatsuha-aa1-n-7-ex1',
//         extraFrom: 're-16-yatsuha-aa1-n-7',
//         baseType: 'special',
//         types: ['action'],
//         cost: '2',
//         namejp: '色づく世界',
...
//         text: '从任意起点出发，开始散樱代的旅途。（每局游戏中每名玩家仅能开始旅途一次，未寄宿八叶的玩家没有回忆区，也无法将结晶置于旅途牌上）\n【使用后】每回合的准备阶段开始时，结算所在地的效果，然后将樱花结晶沿顺时针方向移至下一个地点。当将要第2次结算出发地的效果时，不结算出发地的效果，而改为结算归途的效果。'
//       },
//       {
//         id: 're-16-yatsuha-aa1-n-7-ex2',
//         extraFrom: 're-16-yatsuha-aa1-n-7-ex1',
//         baseType: 'special',
//         cost: '0',
//         types: ['action'],
//         namejp: '彼女にとっての桜降る代',
...
//       range: '3-5',
//       damage: '2/1',
//       text: '【常时】若你处于顺风状态，则此《攻击》获得+1/+2。\n【攻击后】若你处于逆风状态，则虚（2）→距，然后将此牌变为未使用状态。',
//       textjp: '【常時】順風ならば、この《攻撃》は+1/+2となる。\n【攻撃後】逆風ならば、\nダスト→間合：2\nを行い、このカードを未使用に戻す。'
//     },
//     {
//       id: 're-17-hatsumi-o-s-2',
//       namejp: 'オヨギビ砲火',
//       name: '鱼雷炮击',
//       baseType: 'special',
//       cost: '2',
...
//     },
//     {
//       id: 're-18-mizuki-o-s-3',
//       namejp: '大手楯無門',
//       name: '大手楯无门',
//       baseType: 'special',
//       cost: '3',
//       types: ['action'],
//       text: '终端\n选择至多1张手牌，将该牌与追加牌区中的『斗神』以已征兵状态置于兵舍。\n【使用后】你从兵舍中使用的《攻击》牌生成的《攻击》获得+1/+0。',
//       textjp: '終端\n手札のカードを1枚まで選び、それと追加札の「闘神」を兵舎に徴兵済で置く。\n【使用済】あなたが兵舎から使用した《攻撃》カードによる《攻撃》は+1/+0となる。'
//     },
//     {
//       id: 're-18-mizuki-o-s-4',
//       namejp: '山城水津城の鬨の声',
//       name: '山城水津城的喧天号角',
//       baseType: 'special',
//       cost: '5',
...
//         extraFrom: 're-18-mizuki-o-s-3'
//       }, {
//         id: 're-18-mizuki-o-t-1',
//         name: '枪兵',
//         namejp: '槍兵',
//         baseType: 'soldier',
//         types: ['attack'],
...
// },
{
  ...
  list: [{
    ...
    },
    {
      ...
      capacity: '2',
      capacityGrowup: '1',
      textjp: '生育 1\n【常時】Xは土壌以外にあるあなたの種結晶の個数の合計に等しい。\n【展開時】対応した《攻撃》は-X/+0となる。\n【展開中】相手の開始フェイズの開始時に攻撃『適正距離1-6、0/1、【常時】この攻撃は+X/+0となる』を行う。',
      text: '生育1\n【常时】X等于位于土壤以外的你的种子结晶的数量。\n【展开时】被对应的《攻击》获得-X/+0。\n【展开中】每当对手的准备阶段开始时，进行一次“攻击距离1-6 伤害0/1 【常时】此攻击获得+X/+0。”的攻击。'
    },
    {
      id: 're-19-megumi-o-s-3',
      namejp: '結末の果実',
      name: '终结之果实',
      baseType: 'special',
      types: ['enhance'],
      capacity: '2',
      cost: '4',
      textjp: '【展開中】この付与札の上の桜花結晶はメインフェイズに移動しない。開始フェイズの処理であなたの他の付与札から桜花結晶がダストへと送られるならば、それは代わりにこの付与札の上に動かす。\n【展開中】この付与札の上の種結晶が5個になったターンの終了フェイズに、攻撃『適正距離5、5/5、不可避、【常時】この《攻撃》は打ち消されない』を行い、このカードの上の桜花結晶を全てダストに送る。',
    ...
    namejp: '端末',
    isSelect: false,
    pic: 'twiicon_sa_53t.jpg',
    picq: 'sd_megumi_a1.png',
    changenormal: [{
      changeIndex: 2,
      id: 're-19-megumi-a1-n-2',
      name: '假想击',
      namejp: '仮想撃',
      types: ['enhance'],
      capacity: '3',
      text: '【展开时/破弃时】进行一次“攻击距离5-6 伤害3/1”的攻击。',
      textjp: '【展開時/破棄時】攻撃『適正距離5-6、3/1』を行う。'
    }],
    changespecial: [{
      changeIndex: 3,
      id: 're-19-megumi-a1-s-3',
      name: '须臾景之叶',
      namejp: '一幕の葉',
      types: ['attack', 'reaction'],
      range: '4-7',
      damage: '2/X',
      cost: '2',
      text: '【常时】仅在你进行过效果生成的《攻击》的回合内可以使用此牌。\n【常时】X等于置有你的种子结晶的区域（土壤、付与区、假想树）的数目。\n【攻击后】虚（1）→自装',
      textjp: '【常時】あなたが効果による《攻撃》を行っているターンにのみ、このカードは使用できる。\n【常時】Xはあなたの種結晶が置かれている領域（土壌、付与札、仮想樹）の数に等しい。\n【攻撃後】ダスト→自オーラ：１'
    }, {
      changeIndex: 4,
      id: 're-19-megumi-a1-s-4',
      name: '未然境之掌',
      namejp: '彼方よりの掌',
      types: ['action'],
      cost: '2',
      text: '将假想树嫁接于散樱代之上。（若你寄宿了“假想树希”，则获得假想树区域。）\n从你的土壤中选择1个种子结晶，将其置于假想树1的位置上。\n【使用后】在你的主要阶段，你可以使用此牌，而无需支付费用。若如此做，则结算完毕后将此牌移出游戏。',
      textjp: '仮想樹と桜降る代を接ぐ。\nあなとの土壌の種結晶を1つ選び、それを仮想樹１に置く。\n【使用済】あなたのメインフェイズに、コストを支払わずにこのカードを使用してもよい。そうした場合、解決後にこのカードを取り除く。'
    }],
    girlBoard: [{
      id: 're-tree-card',
      name: '【假想树】',
      namejp: '【仮想樹】',
      text: '2-1【花落时】进行一次“攻击距离3-6 伤害3/1”的攻击。\n2-2【花落时】进行一次“攻击距离0-3 伤害1/1”的攻击，虚（1）→距\n3-1【开花中】你的回合内，每当你第一次对敌命造成伤害时，执行至多1次基本动作《装附》或《聚气》。\n3-2【花落时】展示1张你眼前构筑时没有选用的非《全力》且非《付与》的王牌并使用该牌。然后，若该牌将被移至任意区域，则改为将其移出游戏。\n3-3【开花中】你的回合内，每当你第一次对敌装造成伤害时，执行至多1次基本动作《离脱》或《后退》。',
      textjp: '２ー１【散華時】攻撃『適正距離3-6、3/１』を行う\n２ー２【散華時】攻撃『適正距離0-3、1/1』を行う、ダスト→間合：１\n３ー１【開花中】あなたのターンで最初に相手のライフへダメージを与えた時、基本動作《纏い》か《宿し》を１回まで行う\n３ー２【散華時】眼前構築で選んでいない《全力》でも《付与》でもないあなたの切り札を１枚公開し、使用する。使用したそのカードが領域を移動するならば、代わりにそれを取り除く。\n３ー３【開花中】あなたのターンで最初に相手のオーラにダメージを与えた時、基本動作《離脱》か《後退》を1回まで行う。'
    }]
  }]
}
// {
...
//     }],
//     special: [{
//       id: 're-21-kamuwi-o-s-1',
//       namejp: '灯',
//       name: '灯',
//       baseType: 'special',
//       cost: '5',
//       types: ['action'],
//       text: '禁忌+4～将自气中的所有樱花结晶移至虚。将『晓』从追加牌区以未使用状态加入王牌。',
//       textjp: '＜禁忌+4＞あなたのフレアにある桜花結晶すべてをダストに送る。追加札から「暁」を未使用で得る。\n----',
//       textkururu: [{
//         if: '<i class="i-jinji">禁忌+4</i>',
//         ctn: '将自气中的所有樱花结晶移至虚。将『晓』从追加牌区以未使用状态加入王牌。'
//       }],
//       textkururujp: [{
//         if: '<i class="i-jinji">禁忌+4</i>',
//         ctn: 'あなたのフレアにある桜花結晶すべてをダストに送る。追加札から「暁」を未使用で得る。'
//       }]
//     }, {
//       id: 're-21-kamuwi-o-s-2',
//       name: '阡',
//       namejp: '阡',
//       baseType: 'special',
//       cost: '3',
...
//     }],
//     extra: [{
//       id: 're-21-kamuwi-o-s-1-ex1',
//       name: '晓',
//       namejp: '暁',
//       extraFrom: 're-21-kamuwi-o-s-1',
//       baseType: 'special',
//       cost: '6',
//       types: ['attack'],
//       range: '3-7',
...
//     }],
//     extra: [{
//       id: 're-22-renri-o-s-4-ex1',
//       extraFrom: 're-22-renri-o-s-4',
//       name: '铭镌之衣',
//       namejp: '刻まれし衣',
//       baseType: 'special',
//       cost: 'X',
...
//     }],
//     changeExtra: [{
//       id: 're-22-renri-a1-n-6-ex1',
//       extraFrom: 're-22-renri-a1-n-6',
//       name: '谎言的武器',
//       namejp: '偽りの武器',
//       baseType: 'normal',
//       types: ['attack'],
...
//     }, {
//       id: 're-24-shisui-o-s-3',
//       name: '寒疮噬身',
//       namejp: 'アブダグイ',
//       baseType: 'special',
//       cost: '2',
//       types: ['action', 'reaction'],
//       text: '若此牌对应了一个《攻击》，则打消被对应的《攻击》的伤害，你受到一次{X/Y}的裂伤，X和Y分别等于该《攻击》的对装伤害和对命伤害。\n----\n【即再起】你受到了本回合内第3次伤害。',
//       textjp: '対応した《攻撃》のダメージを打ち消す。そうした場合、あなたは{X/Y}の裂傷を受ける。X/Yは打ち消したダメージの値に等しい。\n----\n【即再起】あなたがこのターンに3回目のダメージを受ける。'
//     }, {
//       id: 're-24-shisui-o-s-4',
//       name: '桑畑志水的埋骨地',
//       namejp: '桑畑志水の死に所',
//       baseType: 'special',
//       cost: '2',
...
//       range: '3',
//       damage: '-/0',
//       text: '【常时】若本回合内你进行过共鸣，则此《攻击》获得+0/+1。\n【常时】若本回合内你使用过其他女神的牌，则此《攻击》获得距离扩大（远2）。',
//       textjp: '【常時】あなたがこのターン中に共鳴しているならば、この《攻撃》は+0/+1となる。\n【常時】あなたがこのターン中に他のメガミのカードを使用しているならば、この《攻撃》は距離拡大（遠2）を得る。'
//     }, {
//       id: 're-26-innealra-o1-n-3',
//       name: '祖枪',
//       namejp: '祖槍',
//       baseType: 'normal',
//       types: ['attack'],
//       range: '5-8',
//       damage: '2/1',
//       text: '【攻击后】选择1项。若此《攻击》被对手对应，则改为由对手选择1项：\n1.进行一次共鸣；\n2.将过去的命运轮转至待启的命运。',
//       textjp: '【攻撃後】以下から1つを選ぶ。この《攻撃》が対応されたならば、代わりに相手が選ぶ。\n・共鳴する。\n・過去の運命をまだ見ぬ運命へと動かす。'
//     }, {
//       id: 're-26-innealra-o1-n-4',
//       name: '怅憾',
//       namejp: '悔恨',
//       baseType: 'normal',
//       types: ['action'],
...
//     }, {
//       id: 're-26-innealra-o1-n-6',
//       name: '哀愁意志',
//       namejp: '憂き意志',
//       baseType: 'normal',
//       types: ['enhance'],
//       capacity: '2',
//       text: '【展开时/破弃时】对手弃置1张手牌或1张盖牌。',
//       textjp: '【展開時/破棄時】相手は相手の伏せ札か手札から1枚を捨て札にする。'
//     }, {
//       id: 're-26-innealra-o-n-7',
//       name: '变迁',
//       namejp: '変転',
//       baseType: 'normal',
//       types: ['enhance', 'reaction'],
//       capacity: '1',
//       text: '【展开时】虚（1）→自装\n【破弃时】你可以将过去的命运轮转至待启的命运。',
//       textjp: '【展開時】ダスト→自オーラ：1\n【破棄時】過去の運命をまだ見ぬ運命へと動かしてもよい。'
//     }],
//     special: [{
//       id: 're-26-innealra-o1-s-1',
//       name: '神枪·衰朽',
//       namejp: 'スピエル・サラバエル',
//       baseType: 'special',
//       cost: '2',
...
//       range: '4',
//       damage: '-/1',
//       text: '【常时】此《攻击》获得距离扩大（近X）与距离扩大（远Y），X等于对手处于使用后状态的王牌的牌张数，Y等于对手弃牌区中的牌张数。\n----\n【再起】本回合内，你进行了至少2次共鸣。',
//       textjp: '【常時】この《攻撃》は距離拡大（近X）と距離拡大（遠Y）を得る。Xは相手の使用済の切札の枚数に等しい。Yは相手の捨て札の枚数に等しい。\n------\n再起：あなたがこのターン中に2回以上共鳴している。'
//     }, {
//       id: 're-26-innealra-o1-s-2',
//       name: '掩郁·埋葬',
//       namejp: 'イヤルカス・シラマカス',
//       baseType: 'special',
//       cost: '1',
//       types: ['enhance', 'reaction'],
//       capacity: '1',
//       text: '【展开中】对手的《攻击》不受使其伤害增加的效果的影响。\n（代入与替换类的效果正常结算）',
//       textjp: '【展開中】相手の《攻撃》はダメージが元々の値から加算されない。\n(代入、入れ替えなどは行われる)'
//     }, {
//       id: 're-26-innealra-o1-s-3',
//       name: '栖身·垂暮',
//       namejp: 'イム・クレナズム',
//       baseType: 'special',
//       cost: '3',
//       types: ['action'],
//       text: '【使用后】对手的弃牌区中的牌不会因重铸牌库而移动。\n【使用后】对手重铸牌库后，将此牌移出游戏。',
//       textjp: '【使用済】相手の捨て札にあるカードは山札の再構成により移動しない。\n【使用済】相手が山札の再構成を行った後、このカードを取り除く。'
//     }, {
//       id: 're-26-innealra-o-s-4',
//       name: '造物诺伦神·万劫缠迫',
//       namejp: 'イニルノルニル・アザナエル',
//       baseType: 'special',
//       cost: '5',
//       types: ['enhance', 'fullpower'],
//       capacity: '5',
//       text: '【展开时】盖伏任意张数的手牌，然后执行基本动作，其次数不超过以此法盖伏的牌张数。\n【展开中】将所有命运变为纠缠状态。\n【使用后】不能由其它牌的效果使用此牌。',
//       textjp: '【展開時】手札を好きな枚数だけ伏せ札にする。その枚数に等しい回数まで基本動作を行う。\n【展開中】運命を糾える運命へと導く。\n【使用済】このカードは使用できない。'
//     }],
//     extra: [{
//       id: 're-26-o1-f-1',
//       name: '修省/纠缠修省',
...
//       baseType: 'fate',
//       text: '本回合内，你不能进行《攻击》。\n若当前距离小于等于5，则敌装（1）→距。\n若此命运位于过去，则再结算1次上述效果。\n----\n本回合内，你不能使用通常牌。\n对敌命造成1点伤害。',
//       textjp: 'このターン中、あなたは《攻撃》を行えない。\n現在の間合が5以下ならば、相オーラ→間合：1\nこの運命が過去にあるならば、もう1回行う。\n------\nこのターン中、あなたは通常札を使用できない。\n相手のライフに1ダメージを与える。'
//     }, {
//       id: 're-26-o1-f-2',
//       name: '悔恨/纠缠悔恨',
//       namejp: 'くやみ/糾えるくやみ',
//       baseType: 'fate',
//       text: '本回合内，你不能执行基本动作《前进》或《后退》。\n敌气（1）→敌装\n----\n本回合内，你不能执行基本动作。\n对敌命造成1点伤害。',
//       textjp: 'このターン中、あなたは基本動作《前進》と《後退》を行えない。\n相フレア→相オーラ：1\n------\nこのターン中、あなたは基本動作を行えない。\n相手のライフに1ダメージを与える。'
//     }, {
//       id: 're-26-o1-f-3',
//       name: '怨艾/纠缠怨艾',
//       namejp: 'うらみ/糾えるうらみ',
//       baseType: 'fate',
//       text: '若此命运位于过去，则对敌命造成1点伤害。\n若如此做，则你弃置1张具《对应》副类别的牌。若你未能以此法弃牌，则须展示手牌。\n----\n若你本回合内没有使用过通常牌，则对敌命造成1点伤害。',
//       textjp: 'この運命が過去にあるならば、相手のライフに1ダメージを与える。そうした場合、あなたは手札から《対応》カード1枚を捨て札にする。それが行えない場合、あなたは手札を公開する。\n------\nこのターン中にあなたが通常札を使用していないならば、相手のライフに1ダメージを与える。'
//     }, {
//       id: 're-26-o1-f-4',
//       name: '瞑眠/纠缠瞑眠',
//       namejp: 'まどろみ/糾えるまどろみ',
//       baseType: 'fate',
//       text: '盖伏你与对手牌库顶的1张牌。\n若此命运位于过去，则再结算1次上述效果。\n----\n若你本回合内没有执行过基本动作，则对敌命造成1点伤害。',
...
//       range: '4-5',
//       damage: '2/1',
//       text: '【常时】若本回合内你进行过共鸣，则此《攻击》获得+0/+1。\n【常时】若本回合内你使用过其他女神的牌，则此《攻击》获得+0/+1。',
//       textjp: '【常時】あなたがこのターン中に共鳴しているならば、この《攻撃》は+0/+1となる。\n【常時】あなたがこのターン中に他のメガミのカードを使用しているならば、この《攻撃》は+0/+1となる。'
//     }, {
//       changeIndex: '3',
//       id: 're-26-innealra-o2-n-3',
//       name: '鸣枪',
//       namejp: '鳴槍',
//       baseType: 'normal',
//       types: ['attack'],
...
//     }, {
//       changeIndex: '4',
//       id: 're-26-innealra-o2-n-4',
//       name: '迷惘',
//       namejp: '当惑',
//       baseType: 'normal',
//       types: ['action'],
//       text: '执行至多1次基本动作《装附》或《后退》。\n进行一次共鸣。',
//       textjp: '基本動作《纏い》か《後退》を1回まで行う。\n共鳴する。'
//     }, {
//       changeIndex: '6',
//       id: 're-26-innealra-o2-n-6',
//       name: '脆弱意志',
//       namejp: '脆き意志',
//       baseType: 'normal',
//       types: ['enhance'],
//       capacity: '4',
//       text: '【展开中】若对手将由基本动作《装附》以外的效果将樱花结晶移至敌装，则改为将这些樱花结晶移至此牌上。\n【展开中】对手执行基本动作《装附》时，该基本动作结算完毕后将此牌上的1个樱花结晶移至虚。',
//       textjp: '【展開中】基本動作《纏い》以外で相手のオーラへと桜花結晶が移動するならば、それは代わりにこのカードの上へと移動する。\n【展開中】相手が基本動作《纏い》を行った時、その解決後にこのカードの上から桜花結晶を1つダストに送る。'
//     }],
//     changespecial: [{
//       changeIndex: '1',
//       id: 're-26-innealra-o2-s-1',
//       name: '神枪·啸叹',
//       namejp: 'スピエル・ウレエル',
//       baseType: 'special',
//       types: ['attack'],
...
//       cost: '5',
//       capacity: '1',
//       text: '【展开中】对手的《攻击》获得-1/+0。\n【展开中】对手的《攻击》结算完毕后，对敌装造成1点伤害。',
//       textjp: '【展開中】相手の《攻撃》は-1/+0となる。\n【展開中】相手の《攻撃》の解決後に、相手のオーラに1ダメージを与える。'
//     }, {
//       changeIndex: '3',
//       id: 're-26-innealra-o2-s-3',
//       name: '残恣·嗜灭',
//       namejp: 'シキリス・ホリス',
//       baseType: 'special',
//       types: ['attack'],
...
//       damage: '1/1',
//       cost: '1',
//       text: '【常时】若此《攻击》对敌装造成了伤害，则不将因结算伤害移动的樱花结晶移至虚，而改为移至距。\n----\n【再起】本回合内，你进行了至少2次共鸣。',
//       textjp: '【常時】この《攻撃》のオーラへのダメージにより移動する桜花結晶はダストでなく間合に動かす。\n------\n再起：あなたがこのターン中に2回以上共鳴している。'
//     }],
//     changeExtra: [{
//       id: 're-26-o2-f-1',
//       name: '惶惑/纠缠惶惑',
//       namejp: 'とまどい/糾えるとまどい',
//       baseType: 'fate',
//       text: '敌装（1）→敌气\n若敌装中的樱花结晶的数目大于等于5，则上述箭头效果（→）额外移动1个樱花结晶。\n----\n敌装（2）→自气',
//       textjp: '相オーラ→相フレア：1\n相手のオーラが5以上ならば、この矢印（→）で動く桜花結晶は1つ多くなる。\n------\n相オーラ→自フレア：2'
//     }, {
//       id: 're-26-o2-f-2',
//       name: '颓踏/纠缠颓踏',
//       namejp: 'うつろい/糾えるうつろい',
...
//       id: 're-26-o2-f-3',
//       name: '流离/纠缠流离',
//       namejp: 'ちりまがい/糾えるちりまがい',
//       baseType: 'fate',
//       text: '你畏缩。\n进行一次“攻击距离3-5 伤害2/2”的攻击。\n----\n进行一次“攻击距离2-5 伤害3/2”的攻击。',
//       textjp: 'あなたは畏縮する。\n攻撃『適正距離3-5、2/2』を行う。\n------\n攻撃『適正距離2-5、3/2』を行う。'
//     }, {
//       id: 're-26-o2-f-4',
//       name: '赦赎/纠缠赦赎',
...
//       range: '0-2',
//       damage: '1/1',
//       text: '【常时】若本回合内你进行过共鸣，则此《攻击》获得+1/+0。\n【常时】若本回合内你使用过其他女神的牌，则此《攻击》对对手造成伤害时，不将因结算伤害移动的樱花结晶移至气或虚，而改为移至惑。',
//       textjp: '【常時】あなたがこのターン中に共鳴しているならば、この《攻撃》は+1/+0となる。\n【常時】あなたがこのターン中に他のメガミのカードを使用しているならば、この《攻撃》のダメージにより移動する桜花結晶はダストや　 フレアでなくロストに動かす。'
//     }, {
//       changeIndex: '3',
//       id: 're-26-innealra-o3-n-3',
//       name: '怪枪',
//       namejp: '怪槍',
//       baseType: 'normal',
//       types: ['attack'],
...
//       damage: '2/1',
//       text: '【攻击后】选择1项。若此《攻击》被对手对应，则改为由对手选择1项：\n1.进行一次共鸣；\n2.将过去的命运轮转至待启的命运。',
//       textjp: '【攻撃後】以下から１つを選ぶ。この《攻撃》が対応されたならば、代わりに相手が選ぶ。\n・共鳴する。\n・過去の運命をまだ見ぬ運命へと動かす。'
//     }, {
//       changeIndex: '4',
//       id: 're-26-innealra-o3-n-4',
//       name: '谛观',
//       namejp: '諦観',
//       baseType: 'normal',
//       types: ['action'],
//       text: '执行至多1次基本动作《聚气》或《前进》。\n进行一次共鸣。',
//       textjp: '基本動作《宿し》か《前進》を１回まで行う。\n共鳴する。'
//     }, {
//       changeIndex: '6',
//       id: 're-26-innealra-o3-n-6',
//       name: '虚幻意志',
//       namejp: '儚き意志',
//       baseType: 'normal',
//       types: ['enhance'],
//       capacity: '2',
//       text: '【展开时/破弃时】你可以将过去的命运轮转至待启的命运。\n【展开中】若此牌上的樱花结晶将被移除，则不将其移至虚，而改为移至惑。',
//       textjp: '【展開時/破棄時】過去の運命をまだ見ぬ運命へと動かしてもよい。\n【展開中】この付与札の上の桜花結晶がダストへ送られるならば、かわりにロストへ移動する。'
//     }],
//     changespecial: [{
//       changeIndex: '1',
//       id: 're-26-innealra-o3-s-1',
//       name: '神枪·弥永',
//       namejp: 'スピエル・ナガラエル',
//       baseType: 'special',
//       types: ['attack'],
...
//       damage: '2/1',
//       cost: '2',
//       text: '【常时】若你使用此牌时支付了费用，则不将因支付费用移动的樱花结晶移至虚，而改为移至惑。\n----\n【再起】本回合内，你进行了至少2次共鸣。',
//       textjp: '【常時】このカードの消費の支払いにより移動する桜花結晶はダストでなくロストに動かす。\n------\n再起：あなたがこのターン中に２回以上共鳴している。'
//     }, {
//       changeIndex: '2',
//       id: 're-26-innealra-o3-s-2',
//       name: '决舍·期冀',
//       namejp: 'アイリアス・アルアス',
//       baseType: 'special',
//       types: ['enhance', 'reaction'],
//       cost: '2',
//       capacity: '1',
//       text: '【常时】若你使用此牌时支付了费用，则不将因支付费用移动的樱花结晶移至虚，而改为移至惑。\n【常时】使用此牌时，你可以选择距中的樱花结晶作为此牌的纳。',
//       textjp: '【常時】このカードの消費の支払いにより移動する桜花結晶はダストでなくロストに動かす。\n【常時】使用するに際し、間合から桜花結晶を納めてもよい。'
//     }, {
//       changeIndex: '3',
//       id: 're-26-innealra-o3-s-3',
//       name: '宇宙·幽邃',
//       namejp: 'クレーニャ・アンニャ',
//       baseType: 'special',
//       types: ['action', 'reaction'],
//       cost: '0',
//       text: '你可以将过去的命运轮转至待启的命运。\n自装（1）⇔惑\n【使用后】每回合的准备阶段开始时，进行一次“攻击距离0-10 伤害1/1 【常时】若此《攻击》对对手造成了伤害，则不将因结算伤害移动的樱花结晶移至气或虚，而改为移至惑”的攻击。然后将此牌移出游戏。',
//       textjp: '過去の運命をまだ見ぬ運命へと動かしてもよい。\n自オーラ⇔ロスト:1\n【使用済】各ターンの開始フェイズの開始時に攻撃「適正距離0-10、1/1、【常時】この《攻撃》のダメージにより移動する桜花結晶はダストやフレアでなくロストに動かす」を行う。その後、このカードを取り除く。'
//     }],
//     changeExtra: [{
//       id: 're-26-o3-f-1',
//       name: '歆羡/纠缠歆羡',
//       namejp: 'あこがれ/糾えるあこがれ',
//       baseType: 'fate',
//       text: '惑（3）→虚，然后进行一次“攻击距离0-3 伤害X/1”的攻击，其中X等于通过该箭头效果移动的樱花结晶的数目。\n----\n进行一次“攻击距离0-X 伤害3/5 不可被对应 【常时】X等于惑中樱花结晶的数目”的攻击。\n惑（∞）→虚',
//       textjp: 'ロスト→ダスト：3\n攻撃『適正距離0-3、X/1』を行う。Xはこの矢印（→）で移動した桜花結晶の数に等しい。\n------\n攻撃『適正距離0-X、3/5、対応不可、【常時】Xはロストに等しい』を行う。\nロスト→ダスト：∞'
//     }, {
//       id: 're-26-o3-f-2',
//       name: '掩抑/纠缠掩抑',
//       namejp: 'うなだれ/糾えるうなだれ',
//       baseType: 'fate',
//       text: '若你是由规则进行共鸣，则你获得1点集中力，自装（1）→惑\n否则，对手畏缩，惑（1）→虚\n----\n敌命（1）→惑',
//       textjp: 'ルールによる共鳴ならば以下を行う。\nあなたは集中力を１得て、自オーラ→ロスト：1\nそうでないならば以下を行う。\n相手を畏縮させ、ロスト→ダスト：1\n------\n相ライフ→ロスト：1'
//     }, {
//       id: 're-26-o3-f-3',
//       name: '脱逃/纠缠脱逃',
//       namejp: 'のがれ/糾えるのがれ',
//       baseType: 'fate',
//       text: '若你是由规则进行共鸣，则距（1）→惑\n否则，距（1）→虚，惑（1）→虚\n----\n距（1）→惑\n距（1）→虚',
//       textjp: 'ルールによる共鳴ならば以下を行う。\n間合→ロスト：1\nそうでないならば以下を行う。\n間合→ダスト：1、ロスト→ダスト：1\n------\n間合→ロスト：1\n間合→ダスト：1'
//     }, {
//       id: 're-26-o3-f-4',
//       name: '迷蒙/纠缠迷蒙',
