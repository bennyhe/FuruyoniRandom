...
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      baseType: 'normal',
      types: ['action', 'fullpower'],
      text: '组装：绿紫～\n我方可以从弃牌、盖牌或王牌中选择1张非未使用状态且非《全力》牌的其他女神的卡牌。此时，攻击距离中的所有数值、任意侧的伤害值、献的数量可以选择一项增减1点。\n【常时】本卡牌在盖牌中时，可以视作在我方手牌中并按照标准情况使用。',
      ...
      textkururu: [{
        ...
        ctn: '我方可以从弃牌、盖牌或王牌中选择1张非未使用状态且非《全力》牌的其他女神的卡牌。此时，攻击距离中的所有数值、任意侧的伤害值、献的数量可以选择一项增减1点。'
      }, {
