...
const sakuraDataCh = [{
  ...
  list: [{
    ...
    },
    {
      ...
      baseType: 'normal',
      types: ['action'],
      text: '本回合中，我方下一次《攻击》获得延势（远1）。\n如果我方命小于对方命，执行最多2次基本动作。',
...
},
{
  ...
  },
  {
    ...
    changenormal: [{
      ...
      range: '2-5',
      damage: '3/0',
      text: '【攻击后】如果细音的王牌为使用完毕状态，则对方装（1）→虚\n【攻击后】八相/心境～我方装为1或以下时，或者我方集中力为2时，虚（1）→距\n【攻击后】如果常世的王牌为使用完毕状态，则虚（1）→自装\n（本卡牌同时视作细音和常世的卡牌）',
    ...
    },
    {
      ...
      types: ['enhance'],
      capacity: '3',
      text: '【展开中】八相～每回合对方首次进行《攻击》时，如果我方装为1或一下，或者其他女神的王牌为使用完毕状态，则该《攻击》失去无法对应特性，获得-1/+0。\n【展开时/弃置时】如果细音的王牌为使用完毕状态，则本回合中我方王牌的费用减少1。',
    ...
    changespecial: [{
      ...
      types: ['action'],
      cost: '2',
      text: '【常时】八相～我方装为1或以下时，本卡牌的费用减少1，\n本回合内中我方无法进行《攻击》。\n【使用后】你的其他女神的《攻击》获得+0/+1。\n----\n【即再起】我方命由于《攻击》受到1点或以上伤害时。',
  ...
  },
  {
    ...
    changenormal: [{
      ...
      range: '4-5',
      damage: '3/1',
      text: '（王牌）无法对应\n【常时】进行本《攻击》时，如果对方的装为1或以下，则替换本《攻击》对装造成的伤害与对命造成的伤害数值。',
...
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      baseType: 'normal',
      types: ['action'],
      text: '对方畏缩。\n连火～本卡牌为本回合中使用的第3张或之后的卡牌，则本回合中我方下次对装的伤害为3或以下的的其他女神《攻击》获得+1/+1。',
...
},
{
  ...
  },
  {
    ...
    changenormal: [{
      ...
      range: '5',
      damage: '-/1',
      text: '【常时】如果常世的王牌为使用完毕状态，则本《攻击》获得无法对应特性。\n【攻击后】心境～我方集中力为2时，或者其他女神的王牌为使用完毕状态，将本卡牌放入牌库顶或者牌库底。',
    ...
    changespecial: [{
      ...
      types: ['action'],
      cost: '1',
      text: '心境～我方集中力为2时，本卡牌的花费减少1。\n本回合中我方无法支付集中力。\n【使用后】我方使用其他女神的《对应》牌时，如果当前为我方回合，执行最多1次基本动作《后退》或者《脱离》。如果当前为对方回合，对方畏缩。\n----\n【即再起】我方命由于《攻击》受到1点或以上伤害时。',
...
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      capacity: '3',
      cost: '2',
      text: '【展开时】我方盖伏任意数量的弃牌。\n【展开中】我方从盖牌中使用的卡牌箭头标记改为双向标记。\n【展开中/使用后】我方重组牌库前，可以从盖牌中额外使用1张带有设置特性且非《攻击》的卡牌。',
  ...
  },
  {
    ...
    changespecial: [{
      ...
      damage: '2/1',
      cost: '16',
      text: '【常时】本卡牌的费用减少我方盖牌和拼装状态卡牌数量的合计。\n【攻击后】进行3次『攻击距离3-4，2/1』的攻击。',
      ...
      types: ['action', 'fullpower'],
      cost: '0',
      text: '拼装1个部件，执行最多1次基本动作。\n【使用后】我方重组牌库前，可以将拼装部件分解为1个或以下，如果这么做，拼装X个部件。X为当前盖牌数量的一半（向上取整）。',
    ...
    changeExtra: [{
      ...
      name: '定制部件D',
      namejp: 'カスタムパーツD',
      text: '壹：【攻击后】选择并盖伏最多1张弃牌。\n贰：【攻击后】选择最多1张盖牌，将其放回牌库底。\n叁：【攻击后】选择最多2张盖牌，按照任意顺序将其放回牌库底。\n肆：【攻击后】从弃牌或者盖牌中选择最多2张卡牌，按照任意顺序将其放回牌库底。',
...
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      textkururu: [{
        ctn: '【弃置时】处理当前谋略，并且筹划下一个谋略。'
      }, {
        if: '<i class="i-bean i-bean--plan-blue"></i>',
        ctn: '神算：我方获得1点集中力，并将本卡牌放到牌库顶。'
      }, {
        if: '<i class="i-bean i-bean--plan-red"></i>',
        ctn: '鬼谋：如果对方的手牌为1张或以下，则对方畏缩并且对方抽取3张卡牌，随后对方从手牌中舍弃2张卡牌。'
      }],
      textkururujp: [{
    ...
    },
    {
      ...
      textkururu: [{
        ...
        if: '<i class="i-bean i-bean--plan-blue"></i>',
        ctn: '神算：从我方的弃牌或者使用完毕的王牌中，选择并免费使用1张《付与》牌。如果所选择的卡牌为《全力》牌则结束当前阶段。'
      }, {
        if: '<i class="i-bean i-bean--plan-red"></i>',
        ctn: '鬼谋：选择1张对方场上王牌以外的付与牌。将所选付与牌上所有的樱花结晶移至虚。'
      }],
      textkururujp: [{
        ctn: '計略を実行し、次の計略を準備する。'
      }, {
  ...
  },
  {
    ...
    changenormal: [{
      ...
      textkururu: [{
        ctn: '使用本卡牌对应时，处理当前谋略，并且筹划下一个谋略。'
      }, {
        if: '<i class="i-bean i-bean--plan-blue"></i>',
        ctn: '神算：如果当前对方牌库有3张或以上卡牌，则对对方命造成1点伤害。'
      }, {
        if: '<i class="i-bean i-bean--plan-red"></i>',
        ctn: '鬼谋：如果当前对方牌库有3张或以下卡牌，则对对方装造成2点伤害。'
      }],
      textkururujp: [{
    ...
    },
    {
      ...
      types: ['enhance', 'fullpower'],
      capacity: '2',
      text: '【展开时】可以支付1点集中力并筹划谋略。\n【展开时/弃置时】处理当前谋略，并且筹划下一个谋略。\n神算：进行『攻击距离1,3,5，伤害2/2，锁定，【攻击后】对方选择1张手牌，将所选卡牌放入牌库底。』的攻击。\n鬼谋：进行『攻击距离0,2,4，伤害2/2，锁定，【攻击后】舍弃对方牌库顶的1张卡牌，盖伏对方牌库顶的1张卡牌。』的攻击。',
      ...
      textkururu: [{
        ctn: '【展开时】可以支付1点集中力并筹划谋略。\n【展开时/弃置时】处理当前谋略，并且筹划下一个谋略。'
      }, {
        if: '<i class="i-bean i-bean--plan-blue"></i>',
        ctn: '神算：进行『攻击距离1,3,5，伤害2/2，锁定，【攻击后】对方选择1张手牌，将所选卡牌放入牌库底。』的攻击。'
      }, {
        if: '<i class="i-bean i-bean--plan-red"></i>',
        ctn: '鬼谋：进行『攻击距离0,2,4，伤害2/2，锁定，【攻击后】舍弃对方牌库顶的1张卡牌，盖伏对方牌库顶的1张卡牌。』的攻击。'
      }],
      textkururujp: [{
...
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      types: ['action'],
      cost: '3',
      text: '离心\n我方选择下列项最多2次。可以多次选择同一项。\n·舍弃我方牌库中的所有卡牌。\n·从我方弃牌中选择《全力》牌以外的卡牌，使用所选卡牌。如果此方法使用了《付与》以外的卡牌导致其进入弃牌，则改为盖伏使用的卡牌。',
...
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      range: '1-5',
      damage: '1/1',
      text: '全开：【常时】本《攻击》获得+1/+2。\n全开：【攻击后】对方查看我方毒袋并选择其中1张，将其加入对方手牌。\n【攻击后】如果对方手牌中有毒素牌，则我方执行1次基本动作《装附》。',
...
},
{
  ...
  },
  {
    ...
    changespecial: [{
      ...
      types: ['action'],
      cost: '2',
      text: '组装：红～\n如果对方盖牌数量为0张，则盖伏对方牌库顶的1张卡牌。对方选择对方1张盖牌。我方声明1次所选卡牌的卡牌名称，对方舍弃所选卡牌。如果我方声明的卡牌名称与所选卡牌名称一致，则将1片樱花结晶从游戏外移至本卡牌上。如果本卡牌上的樱花结晶变为2片，则处理世纪大发现的效果（查看对方的所有王牌。然后选择你或者对方，将该玩家眼前构筑时没有选用的5张王牌，从游戏外以未使用状态加入王牌。将「最终嗖寻」移出游戏并从追加牌中将「壮绝旅程」以未使用状态加入王牌。）。\n【使用后】我方在牌库重组时以及使用《全力》牌时，在本回合的结束截断可以不支付任何费用使用本卡牌。',
      ...
      textkururu: [{
        ...
        ctn: '如果对方盖牌数量为0张，则盖伏对方牌库顶的1张卡牌。对方选择对方1张盖牌。我方声明1次所选卡牌的卡牌名称，对方舍弃所选卡牌。如果我方声明的卡牌名称与所选卡牌名称一致，则将1片樱花结晶从游戏外移至本卡牌上。如果本卡牌上的樱花结晶变为2片，则处理世纪大发现的效果（查看对方的所有王牌。然后选择你或者对方，将该玩家眼前构筑时没有选用的5张王牌，从游戏外以未使用状态加入王牌。将「最终嗖寻」移出游戏并从追加牌中将「壮绝旅程」以未使用状态加入王牌。）。'
      }, {
        ctn: '【使用后】我方在牌库重组时以及使用《全力》牌时，在本回合的结束截断可以不支付任何费用使用本卡牌。'
      }],
      textkururujp: [{
        if: '<i class="i-bean i-bean--red"></i>',
...
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      range: '3-7',
      damage: '1/1',
      text: '燃烧\n全开：【常时】本《攻击》获得延势（近1）以及延势（远1），并且获得+2/+2。\n【攻击后】如果未全开使用本卡牌，则我方回复2片燃尽的造花结晶。',
    ...
    },
    {
      ...
      capacity: '3',
      cost: '2',
      text: '【展开中】我方燃尽造花结晶时，从燃尽区域将造花结晶移至引擎区域，而非从引擎区域移至燃尽区域。\n（如果燃尽区域的造花结晶数量不足，则无法燃烧）',
...
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      textjp: '現在の風神ゲージに応じて、以下の切札を追加札から未使用で得る(条件を満たしたものは全て得る)。その後、このカードを取り除く。 3以上……「風魔旋風」 \n7以上……「風魔纏廻」\n12以上……「風魔天狗道」'
    },
    {
      id: '12-raira-o-s-4',
      name: '圆环轮回旋',
...
},
{
  ...
  list: [{
    ...
    normal: [{
      ...
      range: '5-7',
      damage: '2/2',
      text: '【常时】灰尘～虚为12或以上则本《攻击》获得延势（近1），对装的伤害变为「-」。',
  ...
  },
  {
    ...
    changespecial: [{
      ...
      damage: '2/1',
      cost: '2',
      text: '终止\n【使用后】如果我方或对方的结束阶段时，虚未13或以上则终焉之影复苏（将你手牌、牌库、盖牌区、弃牌与付与区中的所有非王牌移出游戏（不结算付与牌的弃置时效果），将因此移出游戏的樱花结晶移至虚，将追加牌「万象乖离歼灭之影」「我等亡殁静寂往灭」「终焉·降临」置于弃牌并洗牌）。随后，移除本卡牌，从追加牌区域以使用完毕状态获得「夙愿」，再抽取1张卡牌，如果我方的命为6或以上，则将樱花结晶移至虚，直到我方命变为5。',
...
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      range: '5',
      damage: '3/2',
      text: '（通常牌）无法对应\n【攻击后】绽放～我方可以将「突击灵式」与追加牌区域中的「神灵樱花」进行交换。如果这么做，我方可以选择将「神灵樱花」放入牌库底。交换后，虚（1）→我方命',
...
},
{
  ...
  list: [{
    ...
    normal: [{
      ...
      range: '3-4',
      damage: '2/1',
      text: '禁忌+1～【常时】本《攻击》获得+1/+0。\n----\n----\n禁忌+1～【攻击后】如果对方装为4或以下，则对方装（1）→我方装。',
    ...
    special: [{
      ...
      cost: '5',
      types: ['action'],
      text: '禁忌+4～将我方气中的樱花结晶全部移至虚。从追加牌区域以未使用状态获得「晓」。',
      textjp: '＜禁忌+4＞あなたのフレアにある桜花結晶すべてをダストに送る。追加札から「暁」を未使用で得る。\n----',
      textkururu: [{
        if: '<i class="i-jinji">禁忌+4</i>',
        ctn: '将我方气中的樱花结晶全部移至虚。从追加牌区域以未使用状态获得「晓」。'
      }],
      textkururujp: [{
        if: '<i class="i-jinji">禁忌+4</i>',
    ...
    , {
      ...
      baseType: 'special',
      types: ['action'],
      text: '我方选择下列项最多3次。可以多次选择同一项。\n·距（1）→虚\n·如果我方命为8或以下，则禁忌槽提升1点。如果这么做，我方装（1）→我方命。',
...
},
{
  ...
  list: [{
    ...
    changenormal: [{
      ...
      baseType: 'normal',
      types: ['variable'],
      text: '【常时】本卡牌可以声明视为对方玩家在眼前构筑阶段能够选择的其他女神的且为《付与》牌以外的通常牌并在标准情况下使用。如果这么做，对方可以从对方的手牌，盖牌或弃牌中展示我方所声明的卡皮。如果对方展示我方所声明的卡牌，则无法使用卡牌并舍弃。',
      ...
      baseType: 'normal',
      types: ['action'],
      text: '（本卡牌使用时没有任何效果）\n【常时】我方重组牌库时，在重组之前如果这张「神授」位于弃牌，则我方可以将「神授」放入牌库顶。如果这么做，从遗物中拿取1张通常牌与其交换。',
    ...
    changespecial: [{
      ...
      types: ['enhance'],
      capacity: '0',
      text: '【使用后】在我方结束阶段时，我方可以使用本卡牌。此时本卡牌视作3献。其中，有1献来自于我方命。\n【展开中】我方的主要阶段开始时，我方可以抽取1张卡牌。\n【展开中】对方由于焦躁效果而受到的伤害改为2/1。\n【展开中】如果我方的伪证没有受到对方反驳，我方可以选择展示卡牌。如果证据为假，则我方获得1点集中力。',
    ...
    changeExtra: [{
      ...
      range: '2-4',
      damage: '1/1',
      text: '伪证设置 伪证 回归\n【攻击后】伪火～我方本回合中使用的第3张卡牌为《攻击》牌时，则那张《攻击》牌所产生的《攻击》获得+0/+1。',
      ...
      range: '3-4',
      damage: '3/1',
      text: '伪证 回归\n【常时】本卡牌回归时，对方的集中力变为0。\n【常时】奉纳～如果我方「道化的决断」上放置有樱花结晶，则本《攻击》获得+0/+1。\n（本卡牌视作斩华的卡牌）',
      ...
      baseType: 'normal',
      types: ['action'],
      text: '伪证 回归\n执行1次基本动作。如果本卡牌没有受到对方反驳，则再执行1次基本动作。\n光辉～如果虚为5或以下，从盖牌中选择1张卡牌，将所选卡牌放入牌库底。\n【常时】本卡牌回归时（在使用卡牌之前）虚（1）→我方命。\n（本卡牌视作樱花的卡牌）',
...
},
{
  ...
  list: [{
    ...
    special: [{
      ...
      types: ['enhance'],
      capacity: '1',
      text: '【展开时】从我方命中移动4片樱花结晶至我方气。\n【展开中】本付与牌上的樱花结晶不会由于本卡牌效果之外的其他效果移动。\n【展开中】如果我方由于命降为0而输掉本局游戏时，改为从我方气中移动4片樱花结晶至我方命。随后，将本付与牌上所有的樱花结晶移至虚，移除本卡牌。',
...
},
{
  ...
  list: [{
    ...
    normal: [{
      ...
      range: '2-5',
      damage: '2/3',
      text: '【攻击后】对手畏缩，我方选择我方装，气或者命受到1点裂伤。',
      ...
      baseType: 'normal',
      types: ['action'],
      text: '距离限制（0-4）\n执行2次基本动作《装附》。我方选择我方装或者气，对方选择对方装或者气。所选区域各受到1点裂伤。',
      ...
      baseType: 'normal',
      types: ['action', 'reaction'],
      text: '选择下述最多X个不同项执行。X为我方在本回合受到伤害的次数。\n·受到对应的《攻击》获得+0/-1。\n·对方畏缩。\n·对方选择对方的装，气或者命受到1点裂伤。',
  ...
  name: 'MISORA 观空',
  namejp: 'ミソラ',
  desc: '瞄准～结束阶段时记录当前距，该数值为瞄准数值。我方回合中进行了《攻击》之后，主要阶段结束时，清空瞄准数值。',
  ...
  list: [{
    ...
    normal: [{
      ...
      range: '4-7',
      damage: '2/1',
      text: '【常时】如果已瞄准，则本次《攻击》对装的伤害变为「-」。\n【攻击后】如果当前距与瞄准数值相同，则虚（1）→我方装。',
      ...
      range: '2-5',
      damage: '1/1',
      text: '【攻击后】对比当前距与瞄准数值，根据结果进行下述处理。\n·当前距>瞄准数值…距（1）→虚\n·当前距=瞄准数值…虚（1）→我方装\n·当前距<瞄准数值…虚（1）→距',
      ...
      range: '5-15',
      damage: '5/1',
      text: '追踪\n【攻击后】对方选择并舍弃1张手牌中的《攻击》牌。如果无法执行，则对方展示手牌，盖伏对方牌库顶的3张卡牌。',
      ...
      baseType: 'normal',
      types: ['action'],
      text: '获得1点集中力。\n本回合中，如果我方下一次→其他女神的通常牌产生的对装伤害不为「-」的《攻击》已瞄准，则获得+1/+1。',
      ...
      baseType: 'normal',
      types: ['action'],
      text: '从盖牌或者眼前构筑阶段未选择的其他女神的卡牌中选择1张《全力》以外的《攻击》通常牌。使用所选卡牌，并且所选卡牌视作带有追踪特性。如果从游戏外选择卡牌且所选卡牌会进入其他区域，则改为背面朝上移除。\n（即恢复至眼前构筑阶段未选择的状态）',
    ...
    special: [{
      ...
      range: 'X',
      damage: '-/1',
      text: '追踪 无法对应\n【常时】X为本卡牌上樱花结晶数量的2倍加上3。\n【攻击后】如果X为7或以上，盖伏对方牌库所有卡牌。\n【使用后】我方结束阶段时，将1片樱花结晶从虚移至本卡牌上，将本卡牌设为未使用状态。',
      ...
      types: ['enhance'],
      capacity: '1',
      text: '【展开中】如果我方有瞄准数值，则当前距等于我方瞄准数值。\n【展开中】我方无法执行基本动作《前进》与《脱离》。',
      ...
      types: ['enhance', 'reaction'],
      capacity: '3',
      text: '【展开时】如果正在对应的通常牌的《攻击》的攻击距离包含我方的瞄准数值，则打消正在对应的《攻击》，将所对应的卡牌放置于本卡牌下方封印。\n【弃置时】本卡牌下方封印的卡牌返还至对方的弃牌。',
  ...
  name: 'INNEALRA 造物诺伦神',
  namejp: 'イヌル',
  desc: '共鸣～第1回合之外的我方主要阶段开始时，如果我方手牌恰好为3张则共鸣。',
  ...
  list: [{
    ...
    normal: [{
      ...
      range: '5-8',
      damage: '2/1',
      text: '【攻击后】我方选择下述1项执行。如果本《攻击》受到对应，则改为对方选择。\n·共鸣。\n·将「过去」的命运移动至「未知的命运」。',
      ...
      id: '26-innealra-o-n-5',
      name: '雨露霜雪',
      namejp: '雨露霜雪',
      baseType: 'normal',
      types: ['action', 'fullpower'],
      text: '执行最多1次基本动作。\n按照「过去」、「现在」、「未来」的顺序处理命运效果。\n（由于不是共鸣，因此不会改变命运的位置）',
      textjp: '基本動作を1回まで行う。\n過去、現在、未来の順で運命の効果を解決する。\n(共鳴ではないので、運命は動かない) '
    }, {
      id: '26-innealra-o1-n-6',
      name: '忧伤意志',
      namejp: '憂き意志',
      baseType: 'normal',
      types: ['enhance'],
      capacity: '2',
      text: '【展开时/弃置时】对方舍弃对方的1张盖牌或手牌。',
      textjp: '【展開時/破棄時】相手は相手の伏せ札か手札から1枚を捨て札にする。'
    }, {
      id: '26-innealra-o-n-7',
      name: '转变',
      namejp: '変転',
      baseType: 'normal',
      types: ['enhance', 'reaction'],
      capacity: '1',
      text: '【展开时】虚（1）→我方装。\n【弃置时】我方可以将「过去」的命运移动至「未知的命运」。',
      textjp: '【展開時】ダスト→自オーラ：1\n【破棄時】過去の運命をまだ見ぬ運命へと動かしてもよい。'
    }],
    special: [{
      id: '26-innealra-o1-s-1',
      name: '神枪·无垠',
      namejp: 'スピエル・サラバエル',
      baseType: 'special',
      cost: '2',
      ...
      range: '4',
      damage: '-/1',
      text: '【常时】本《攻击》获得延势（近X）和延势（远Y）。X等于对方使用完毕状态的王牌数量。Y等于对方的弃牌数量。\n------\n【再起】我方在本回合中进行了2次或以上共鸣。',
      textjp: '【常時】この《攻撃》は距離拡大（近X）と距離拡大（遠Y）を得る。Xは相手の使用済の切札の枚数に等しい。Yは相手の捨て札の枚数に等しい。\n------\n再起：あなたがこのターン中に2回以上共鳴している。'
    }, {
      id: '26-innealra-o1-s-2',
      name: '葬仪·湮隐',
      namejp: 'イヤルカス・シラマカス',
      baseType: 'special',
      cost: '1',
      types: ['enhance', 'reaction'],
      capacity: '1',
      text: '【展开中】对方《攻击》的伤害无法再其基础数值上计算加值。\n（代入、替换等仍需结算）',
      textjp: '【展開中】相手の《攻撃》はダメージが元々の値から加算されない。\n(代入、入れ替えなどは行われる)'
    }, {
      id: '26-innealra-o1-s-3',
      name: '',
      namejp: 'イム・クレナズム',
      baseType: 'special',
      cost: '3',
      ...
      types: ['enhance', 'fullpower'],
      capacity: '5',
      text: '【展开时】盖伏任意数量的手牌。根据盖伏卡牌的数量，最多执行同样次数的基本动作。\n【展开中】将命运引导至交错的命运。\n【使用后】无法使用本卡牌。',
    ...
    extra: [{
      ...
      namejp: 'かえりみ/糾えるかえりみ',
      baseType: 'fate',
      text: '本回合中，我方无法进行《攻击》。\n当前距为5或以下时，对方装（1）→距\n如果此命运位于「过去」，再处理1次上述效果。\n------\n本回合中，我方无法使用通常牌，对对方命造成1点伤害。',
      ...
      namejp: 'くやみ/糾えるくやみ',
      baseType: 'fate',
      text: '本回合中，我方无法执行基本动作《前进》和《后退》。\n对方气（1）→对方装\n------\n本回合中，我方无法执行基本动作。对对方命造成1点伤害。',
      ...
      namejp: 'うらみ/糾えるうらみ',
      baseType: 'fate',
      text: '如果此命运位于「过去」，对对方命造成1点伤害。一旦这么做，我方从手牌中舍弃1张《对应》牌。如果无法执行，公开我方的手牌。\n------\n本回合中，如果我方没有使用通常牌，则对对方命造成1点伤害。',
      ...
      namejp: 'まどろみ/糾えるまどろみ',
      baseType: 'fate',
      text: '盖伏我方与对方牌库顶的1张卡牌。\n如果此命运位于「过去」，再处理1次上述效果。\n------\n本回合中，如果我方没有执行基本动作，则对对方命造成1点伤害。',
    ...
    changenormal: [{
      ...
      range: '4-5',
      damage: '2/1',
      text: '【常时】如果我方在本回合中进行了共鸣，则本《攻击》获得+0/+1。\n【常时】如果我方在本回合中使用了其他女神的卡牌，则本《攻击》获得+0/+1。',
      textjp: '【常時】あなたがこのターン中に共鳴しているならば、この《攻撃》は+0/+1となる。\n【常時】あなたがこのターン中に他のメガミのカードを使用しているならば、この《攻撃》は+0/+1となる。'
    }, {
      changeIndex: '3',
      id: '26-innealra-o2-n-3',
      name: '鸣枪',
      namejp: '鳴槍',
      baseType: 'normal',
      types: ['attack'],
      ...
      changeIndex: '4',
      id: '26-innealra-o2-n-4',
      name: '迷惘',
      namejp: '当惑',
      baseType: 'normal',
      types: ['action'],
      text: '执行最多1次基本动作《装附》或者《后退》。\n共鸣。',
      textjp: '基本動作《纏い》か《後退》を1回まで行う。\n共鳴する。'
    }, {
      changeIndex: '6',
      id: '26-innealra-o2-n-6',
      name: '脆弱意志',
      namejp: '脆き意志',
      baseType: 'normal',
      types: ['enhance'],
      capacity: '4',
      text: '【展开中】对方通过执行基本动作《装附》以外的方法从其他区域将樱花结晶移动至对方装时，改为移动至本卡牌上。\n【展开中】对方执行基本动作《装附》时，处理完毕之后将1片樱花结晶从本卡牌上移至虚。',
      textjp: '【展開中】基本動作《纏い》以外で相手のオーラへと桜花結晶が移動するならば、それは代わりにこのカードの上へと移動する。\n【展開中】相手が基本動作《纏い》を行った時、その解決後にこのカードの上から桜花結晶を1つダストに送る。'
    }],
    changespecial: [{
      changeIndex: '1',
      id: '26-innealra-o2-s-1',
      name: '神枪·悲悯',
      namejp: 'スピエル・ウレエル',
      baseType: 'special',
      types: ['attack'],
      ...
      cost: '5',
      capacity: '1',
      text: '【展开中】对方《攻击》获得-1/+0。\n【展开中】对方《攻击》处理完毕后，对对方装造成1点伤害。',
      textjp: '【展開中】相手の《攻撃》は-1/+0となる。\n【展開中】相手の《攻撃》の解決後に、相手のオーラに1ダメージを与える。'
    }, {
      changeIndex: '3',
      id: '26-innealra-o2-s-3',
      name: '破灭·残景',
      namejp: 'シキリス・ホリス',
      baseType: 'special',
      types: ['attack'],
      ...
      damage: '1/1',
      cost: '1',
      text: '【常时】处理本《攻击》对装所造成的伤害时，将樱花结晶移动至距，而不是虚。\n------\n【再起】我方在本回合中进行了2次或以上共鸣。',
    ...
    changeExtra: [{
      ...
      namejp: 'とまどい/糾えるとまどい',
      baseType: 'fate',
      text: '对方装（1）→对方气\n对方的装为5或以上时，则本卡牌的箭头效果额外移动1片樱花结晶。\n------\n对方装（2）→我方气',
    ...
    changenormal: [{
      ...
      changeIndex: '4',
      id: '26-innealra-o3-n-4',
      name: '达观',
      namejp: '諦観',
      baseType: 'normal',
      types: ['action'],
      text: '执行最多1次基本动作《聚气》或者《前进》。\n共鸣。',
      textjp: '基本動作《宿し》か《前進》を１回まで行う。\n共鳴する。'
    }, {
      changeIndex: '6',
      id: '26-innealra-o3-n-6',
      name: '漂渺意志',
      namejp: '儚き意志',
      baseType: 'normal',
      types: ['enhance'],
      capacity: '2',
      text: '【展开时/【弃置时】我方可以将「过去」的命运移动至「未知的命运」。\n【常时】需要将本付与牌上的樱花结晶移至虚时，改为移动至遗失。',
      textjp: '【展開時/破棄時】過去の運命をまだ見ぬ運命へと動かしてもよい。\n【展開中】この付与札の上の桜花結晶がダストへ送られるならば、かわりにロストへ移動する。'
    }],
    changespecial: [{
      changeIndex: '1',
      id: '26-innealra-o3-s-1',
      name: '神枪·幻湮',
      namejp: 'スピエル・ナガラエル',
      baseType: 'special',
      types: ['attack'],
      ...
      cost: '2',
      capacity: '1',
      text: '【常时】支付本卡牌的费用时，将樱花结晶移动至遗失，而不是虚。\n【常时】使用本卡牌时，可以将距中的樱花结晶作为献放置在本卡牌上。',
      textjp: '【常時】このカードの消費の支払いにより移動する桜花結晶はダストでなくロストに動かす。\n【常時】使用するに際し、間合から桜花結晶を納めてもよい。'
    }, {
      changeIndex: '3',
      id: '26-innealra-o3-s-3',
      name: '梦觉·宵宇',
      namejp: 'クレーニャ・アンニャ',
      baseType: 'special',
      types: ['action', 'reaction'],
      cost: '0',
      text: '我方可以将「过去」的命运移动至「未知的命运」。\n我方装（1）→遗失。\n【使用后】在各回合开始阶段开始时，进行『攻击距离0-10，1/1，【常时】处理本《攻击》所造成的伤害，将樱花结晶移动至遗失，而不是虚或者气。』的攻击。随后，移除本卡牌。',
    ...
    changeExtra: [{
      ...
      namejp: 'あこがれ/糾えるあこがれ',
      baseType: 'fate',
      text: '遗失（3）→虚\n进行『攻击距离0-3，X/1』的攻击。\nX等于通过本剪头效果移动的樱花结晶数量。\n------\n进行『攻击距离0-X，3/5，无法对应，【常时】X等于遗失中樱花结晶的数量』的攻击。\n遗失（∞）→虚',
