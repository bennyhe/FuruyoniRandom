...
},
{
  ...
  list: [{
    ...
    changespecial: [{
      ...
      cost: '1',
      text: '【常时】若此《攻击》对对手造成了伤害，则不将因结算伤害移动的樱花结晶移至气或虚，而改为移至距。\n----\n【再起】本回合内，你进行了至少2次共鸣。',
      textjp: '【常時】この《攻撃》のダメージにより移動する桜花結晶はダストやフレアでなく間合に動かす。\n------\n再起：あなたがこのターン中に2回以上共鳴している。'
    }],
    changeExtra: [{
      id: '26-o2-f-1',
      name: '惶惑/纠缠惶惑',
    ...
    changenormal: [{
      ...
      types: ['enhance'],
      capacity: '2',
      text: '【展开时】你可以将过去的命运轮转至待启的命运。\n【展开中】达人距离减小1。',
      textjp: '【展開時】過去の運命をまだ見ぬ運命へと動かしてもよい。\n【展開中】達人の間合は１小さくなる。'
    }],
    changespecial: [{
      changeIndex: '1',
      ...
      types: ['action'],
      cost: '0',
      text: '你可以将过去的命运轮转至待启的命运。\n【使用后】你的准备阶段开始时，你可以进行一次“攻击距离X 伤害2/1 不可被闪避 【常时】X等于惑中樱花结晶的数目。”的攻击。若如此做，则将此牌移出游戏。',
    ...
    changeExtra: [{
      ...
      namejp: 'あこがれ/糾えるあこがれ',
      baseType: 'fate',
      text: '惑（3）→虚\n若你以此法移动的樱花结晶的数目大于等于3，则进行一次“攻击距离0-3 伤害3/1”的攻击。\n----\n进行一次“攻击距离0-X 伤害3/5 不可被对应 【常时】X等于惑中樱花结晶的数目”的攻击。\n惑（∞）→虚',
      textjp: 'ロスト→ダスト：3\nこの効果で３個以上の桜花結晶が移動したならば、攻撃『適正距離0-3、3/1』を行う。\n------\n攻撃『適正距離0-X、3/5、対応不可、【常時】Xはロストに等しい』を行う。\nロスト→ダスト：∞'
    }, {
      id: '26-o3-f-2',
      name: '掩抑/纠缠掩抑',
      namejp: 'うなだれ/糾えるうなだれ',
