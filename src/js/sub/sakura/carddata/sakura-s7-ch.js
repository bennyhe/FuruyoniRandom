...
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      baseType: 'normal',
      types: ['action'],
      text: '离心 我方选择下述1项执行。\n1.本回合中我方的下一次《攻击》获得无法对应。\n2.本回合中我方的下一次《攻击》如果对装的伤害为3或以上则获得+0/+1；否则获得+2/+0。',
...
},
{
  ...
  list: [{
    ...
    changespecial: [{
      ...
      range: '0-7',
      damage: '1/0',
      text: '【使用后】我方重组牌库时，可以在牌库重组之前选择并公开1张八叶的弃牌或者手牌，随后将其替换为完全形态。\n（例如，可以将手牌中的「星云爪」公开，并将其与追加牌中的「摘星爪」进行交换，随后放回手牌。）',
...
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      types: ['enhance'],
      capacity: '1',
      text: '破绽\n【展开中】本卡牌上的樱花结晶仅会在我方回合且当前为顺风状态时移动。\n【弃置时】进行『攻击距离2-7，1/-，【攻击后】盖伏对方的牌库的所有卡牌。』的攻击。',
...
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      cost: '4',
      types: ['action'],
      text: '终止\n将我方1张手牌以及追加牌区域中的「斗神」放入兵舍并设为征兵状态。',
...
},
{
  ...
  list: [{
    ...
    normal: [{
      ...
      range: '1-4',
      damage: '1/1',
      text: '禁忌+1～【攻击后】打消受到对应的《攻击》。如果借此打消王牌的《攻击》，则禁忌槽提升2点。',
      textjp: '＜禁忌+1＞【攻撃後】対応した《攻撃》を打ち消す。その《攻撃》が切札ならば、禁忌ゲージを2上げる。\n----',
      textkururu: [{
        if: '<i class="i-jinji">禁忌+1</i>',
        ctn: '【攻击后】打消受到对应的《攻击》。如果借此打消王牌的《攻击》，则禁忌槽提升2点。'
      }],
      textkururujp: [{
        if: '<i class="i-jinji">禁忌+1</i>',
    ...
    special: [{
      ...
      types: ['enhance'],
      capacity: '4',
      text: '禁忌+1～【展开时】进行『攻击距离3-4，3/3，（通常牌）无法对应』的攻击。\n【常时】如果本卡牌上放置有樱花结晶，我方无法获得胜利。',
      textjp: '＜禁忌+1＞【展開時】攻撃『適正距離3-4、3/3、対応不可（通常札）』を行う。\n----\n【常時】このカードの上に桜花結晶が置かれているならば、あなたは勝利できない。',
      textkururu: [{
        if: '<i class="i-jinji">禁忌+1</i>',
        ctn: '【展开时】进行『攻击距离3-4，3/3，（通常牌）无法对应』的攻击。'
      }, {
        ctn: '【常时】如果本卡牌上放置有樱花结晶，我方无法获得胜利。'
      }],
      textkururujp: [{
        if: '<i class="i-jinji">禁忌+1</i>',
...
},
{
  name: 'RENRI 恋离',
  namejp: 'レンリ',
  desc: '伪证～在标准情况下使用通常牌时可以进行伪证，每种带有伪证特性的卡牌每回合都可以用此法声明1次。如未收到反驳，则按照所声明的伪证牌使用，随后盖伏。如收到反驳，伪证为假则无法使用卡牌并舍弃。证据为真则对方触发1次焦躁，随后再使用卡牌。',
  ...
  list: [{
    ...
    normal: [{
      ...
      range: '1-2',
      damage: '2/1',
      text: '伪证\n【常时】如果本伪证没有收到对方反驳，则我方可以选择公开本卡牌。如果证据为假，则对方无法选择装受到伤害。\n（选择公开本卡牌则处理完毕后舍弃）',
