  ...
  list: [{
    ...
    },
    {
      ...
      textkururu: [{
        ...
        if: '<i class="i-bean i-bean--plan-red"></i>',
        ctn: '鬼谋：若对手的手牌张数小于等于1，则对手畏缩，对手抓3张牌，然后弃2张牌。'
      }],
      textkururujp: [{
...
},
{
  ...
  list: [{
    ...
    },
    {
      ...
      range: '1-5',
      damage: '1/1',
      // text: '【攻击后】若对手的手牌张数大于等于2，则对手弃1张牌。',
...
},
{
  ...
  },
  {
    ...
    },
    {
      ...
      types: ['enhance'],
      capacity: '2',
      text: '【破弃时】对手弃置其牌库与手牌。对手的集中力变为0，对手畏缩。',
