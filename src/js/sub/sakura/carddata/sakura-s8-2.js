...
},
{
  ...
  },
  {
    ...
    changespecial: [{
      ...
      types: ['action'],
      cost: '2',
      text: '机巧～红：若对手盖牌区的牌张数为0，则盖伏对手牌库顶的1张牌。对手从其盖牌中选择1张牌。你宣言1个牌名，并弃置所选择的牌。若你宣言的牌名与该牌的牌名一致，则将1个樱花结晶从游戏外移至此牌上。然后若此牌上的樱花结晶的数目变为2，则将这些结晶移至虚，进行世纪的大发现（查看对手的所有王牌。然后选择你或者对手，将该玩家眼前构筑时未选用的5张王牌，从游戏外以未使用状态加入王牌。将『不懈探索』移出游戏并将『壮绝旅途』从追加牌区以未使用状态加入王牌。）。\n【使用后】每当你重铸牌库时，或每当你使用具《全力》副类别的牌时，该回合的结束阶段开始时你可以使用此牌，而无需支付其费用。',
      ...
      textkururu: [{
        ...
        ctn: '若对手盖牌区的牌张数为0，则盖伏对手牌库顶的1张牌。对手从其盖牌中选择1张牌。你宣言1个牌名，并弃置所选择的牌。若你宣言的牌名与该牌的牌名一致，则将1个樱花结晶从游戏外移至此牌上。然后若此牌上的樱花结晶的数目变为2，则将这些结晶移至虚，进行世纪的大发现（查看对手的所有王牌。然后选择你或者对手，将该玩家眼前构筑时未选用的5张王牌，从游戏外以未使用状态加入王牌。将『不懈探索』移出游戏并将『壮绝旅途』从追加牌区以未使用状态加入王牌。）。'
      }, {
