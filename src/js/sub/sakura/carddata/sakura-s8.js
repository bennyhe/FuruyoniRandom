...
},
{
  ...
  list: [{
    ...
    normal: [{
      ...
      range: '1-5',
      damage: '2/0',
      text: '终端\n【攻击后】若你的资本与对手的资本之差大于等于3，则从弃牌区中选择至多1张其他女神的牌置入手牌。\n【攻击后】若你的资本大于对手的资本，则你可以执行1次基本动作。',
...
},
{
  ...
  list: [{
    ...
    special: [{
      ...
      cost: '3',
      types: ['action', 'reaction'],
      text: '【常时】若此牌对应了一个《攻击》，则此牌于该《攻击》结算完毕后结算。选择任意数量的区域。将所选择的区域中的你的裂伤指示物以任意顺序伤害化。然后进行一次“攻击距离1-4 伤害2/1 不可被对应（通常牌） 【常时】此攻击获得+0/+X，X等于本回合内你受到伤害的次数的一半（向上取整）。”的攻击',
      ...
      cost: '2',
      types: ['action', 'reaction'],
      text: '打消被对应的《攻击》。若以此法打消了《攻击》，则你受到一次{X/Y}的裂伤，X和Y分别等于该《攻击》的对装伤害和对命伤害。\n----\n【即再起】你受到了本回合内第3次伤害。',
